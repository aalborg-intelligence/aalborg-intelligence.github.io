...
description-meta: "Simple sprogmodeller."
---

# Simple sprogmodeller

Sandsynligheden for næste ord {#sandsynligheden-for-næste-ord .unnumbered}
-----------------------------

Vi tager udgangspunkt i en sprogmodel, der skal kunne gætte næste ord i
en sætning. Hvis vi fx ved, at en sætning starter med
$$
...
Start box: betingede sandsynligheder

Her har vi brugt notationen for betingede sandsynligheder. Hvis $A$ og
...
$$
Her er $A\cap B$
*fælleshændelsen*, det vil sige hændelsen, at $A$ og $B$ forekommer
...
Dette giver mening i forhold til
[\[eq:betinget\]](#eq:betinget){reference-type="eqref"
reference="eq:betinget"}, idet brøken angiver, hvor stor en andel af
sandsynligheden for $B$, der udgøres af sandsynligheden for, at $A$
...
går en tur i\" findes i vores tekstkorpus. Malene laver fodnote Selv
hvis den gør, er det ikke sikkert, at alle relevante fortsættelser
(\"byen\", \"parken\", \"haven\", \...) er repræsentereret. Man er
derfor nødt til at gøre noget smartere. Det kan gøres på mange måder, og
vi ser først på en naiv tilgang kaldet *$N$-gram sprogmodeller*.

$N$-gram sprogmodeller {#n-gram-sprogmodeller .unnumbered}
----------------------
...
Tabel 1 nedenfor er der lavet en hyppighedstabel over alle bigram i
...
andet ord i bigrammet. Fx betyder de to 4-taller i anden række, at \"en
...
$$
Hvis fx det seneste ord i vores sætning er \"løber\", så er
...
-   Bigramtabellen siger nu, at der i vores tekst er to muligheder for
...
-   Vi har nu \"En kat\" og kigger i bigramtabellen efter et ord, der
...
-   Nu har vi \"En kat løber\". Hvad kommer efter \"løber\"? Det gør
...
-   Vi har \"En kat løber en\". Næste mulige ord er \"hund\" og \"kat\",
    som er lige sandsynlige. Vi får \"kat\".

-   Vi slutter her og ender med sætningen \"En kat løber en kat\". Det
...
på tre ord efter hinanden. I Tabel 2 nedenfor er vist hyppigheden af
...
Søjlen til venstre i Tabel 2 er de første to ord i trigrammet, mens
...
-   Lad os begynde som i bigram-eksemplets Trin 2, hvor vi har \"En
    kat\". Der er igen to muligheder: \"en kat løber\" og \"en kat en\".
    Lad os sige, vores tilfældige valg giver \"en kat løber\"

-   Nu skal vi finde en mulighed til \"kat løber \...\" og der kan vi
    vælge \"en\" eller \"ikke\". Vi kan ikke vælge \"efter\", som vi
    kunne i bigram-modellen. Vi rammer måske \"En kat løber ikke\"

-   Vi skal finde et ord til \"løber ikke \...\" og der er nu kun
    \"efter\" at vælge.

-   Vi har \"en kat løber ikke efter\" og har kun muligheden \"ikke
    efter en\"

-   Fra \"en kat løber ikke efter en\", kan vi vælge \"hund\" eller
...
Mere avancerede sprogmodeller {#mere-avancerede-sprogmodeller .unnumbered}
-----------------------------
...
stor sprogmodel, som en model for sprogets betydning. Som et eksempel
på, hvordan det kan gøres, kan du læse om Word2Vec her. Kort fortalt er
idéen at repræsentere hvert ord med en vektor, hvor ord, hvis betydning
minder om hinanden svarer til vektorer, med nogenlunde samme retning og
længde. Måske et simpelt plot med vektorer for \"hund\", \"kat\" og
\"æble\" eller lignende\... Når vi har lavet vektorrepræsentationer af
alle ord i sproget, skal vi bruge dem til at lave prædiktioner af næste
ord ud fra de foregående. Til det kan man benytte en form for *neuralt
netværk*, som du kan læse mere om her. I praksis bruges dog en
*transformer* link, som er endnu mere avanceret, og som i praksis er den
