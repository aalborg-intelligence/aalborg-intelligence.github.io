...
description-meta: "Introduktion til sprogmodeller."
---

Planen er at lave 5 noter, som kan læses i følgende rækkefølge:

-   Introduktion til sprogmodeller (anbefales),

-   simple sprogmodeller (blød introduktion, kan udelades),
...
generative AI-programmer. Men I kender det også fra fx
...
kan en computer fx vide om \"en god kost\" refererer til mad eller en
...
Prædiktion af næste ord {#prædiktion-af-næste-ord .unnumbered}
-----------------------

Fælles for mange sprogmodeller er, at de virker ved at gætte
(*prædiktere*) det næste ord i en sætning ud fra de foregående.
Generativ AI virker fx ved at bygge sætninger op et ord ad gangen, hvor
...
Sprogmodellen gætter så på et af de mest sandsynlige ord som det næste.
I noten om \"Simple sprogmodeller\" link ser vi på, hvordan man lidt
naivt kunne gøre det ved at tælle, hvor hyppigt forskellige
ordkombinationer forekommer, og hvorfor det ikke er en god idé.

Store sprogmodeller {#store-sprogmodeller .unnumbered}
-------------------
...
der bl.a. skyldes den danske sprogforsker [Louis
...
I \"Word2Vec\" ser vi på en matematisk model for sproget, hvor alle ord
bliver repræsenteret som vektorer, der inkorporerer netop denne slags
...
\"Tekstgenerering med neurale netværk\" link.
