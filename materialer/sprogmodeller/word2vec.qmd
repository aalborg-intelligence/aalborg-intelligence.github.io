...
e)    Stemmer resultatet overens med, hvilke ord der er tættest på \"kat\" i
    betydning? 
f)   Tegn vektorerne ind i GeoGebra. Skriv for eksempel `v(0,2,1)` i inputfeltet i GeoGebra og vælg derefter \"Vis\" $\rightarrow$ \"3D Grafik\".
...
b) Hvad er sandsynligheden for, at hvert af de tre ord er 
    kontekst til \"sommer\"? 
c) Hvilket af de tre ord optræder oftest som kontekst til sommer?
