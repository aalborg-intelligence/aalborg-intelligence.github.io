...
Det er illustreret på @fig-spille. Det ses, at retningen på $\vec{v}_{\text{spille}}$ er blevet trukket over mod $\vec{v}_{\text{orkesteret}}$ og væk fra $\vec{v}_{\text{landsholdet}}$.
