...
da bliver sandsynligheden ifølge @def-haendelse:
...
Vi benytter @thm-AcapB på begge sider af lighedstegnet og får:
...
$$
I @exm-eks13 har vi udregnet $P(\textrm{fodbold}) = 42 \%$ og $P(\textrm{fodbold } | \textrm{ dreng}) = 60 \%$. Da der er $200$ drenge ud af i alt $500$ gymnasieelever, er $P(\textrm{dreng}) = 40 \%$, og vi kender derfor alle sandsynligheder på højre side i ovenstående udtryk og får
...
Fra @def-haendelse  følger det, at 
