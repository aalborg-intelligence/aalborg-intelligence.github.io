...
\end{aligned}
$$
Hvilke af disse er mon ens? Her er det mængderne $A$ og $C$, som er ens, hvilket viser, at rækkefølgen ved opskrivningen af elementerne ikke er vigtig. Det vigtige er altså blot, om et element er med i mængden eller ej.
...
Dette er illustreret i @fig-AsubsetB, som kaldes for et Venn-diagram.

![Venn-diagram som illustrerer, at $A$ er en delmængde af $B$: $A\subseteq B$.](images/AsubsetB.png){#fig-AsubsetB width=60% fig-align="center"}
...
Lad $U$ være et udfaldsrum. En delmængde $A$ af udfaldsrummet kaldes for en hændelse. 
...
Du finder en opgave om betinget sandsynlighed og uafhængighed her: [Opgave 1](../../undervisningsforlob/sandsynlighedsregning.qmd#betinget-sandsynlighed).
...
Du finder en opgave om opdeling og sandsynlighed her: [Opgave 2](../../undervisningsforlob/sandsynlighedsregning.qmd#opdeling-og-sandsynlighed).
