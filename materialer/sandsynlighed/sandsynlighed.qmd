...
description: "I denne note giver vi en kort introduktion til mængdeteori og sandsynlighedsregning -- herunder betinget sandsynlighed og uafhængige hændelser. "
---
...
Vi tænker, at man slår med en almindelig terning, hvor udfaldet kan være $1,2,3,4,5,6$. Udfaldsrummet er altså $U= \{1,2,3,4,5,6\}.$
...
Hvis sandsynligheden for hvert udfald er den samme kaldes sandsynlighedsfeltet for symmetrisk. Det vil sige, at sandsynlighedsfeltet i @exm-eks6 er symmetrisk. Hvis der i alt er $n$ udfald, vil sandsynligheden for et enkelt udfald $u\in U$ i et symmetrisk sandsynlighedsfelt være
...
$$
I @exm-eks13 har vi udregnet $P(\textrm{fodbold}) = 42 \%$ og $P(\textrm{fodbold } | \textrm{ dreng}) = 60 \%$. Da der er $200$ drenge ud af i alt $500$ gymnasieelever er $P(\textrm{dreng}) = 40 \%$ alle sandsynligheder og får derfor
...
$$
hvilket stemmer med det, vi fik i @exm-eks14. Bemærk, at vi her har udregnet den betingede sandsynlighed $P(\textrm{dreng } | \textrm{ fodbold})$ [uden]{.underline} at kende det faktiske antal elever. Det er nok at kende de procenter, som vi startede med i eksemplet.
