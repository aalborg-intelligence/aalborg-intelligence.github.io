...
1) Outputværdien afhænger af inputværdierne $x_1, x_2, \dots, x_n$:
   ...
   Det er den måde, vi forstår feedforward-ligninger på: Vi beregner outputværdien $o$ ud fra inputværdierne $x_1, x_2, \dots, x_n$. Vi kan altså her tænke på outputværdien som **en funktion af inputværdierne $x_1, x_2, \dots, x_n$**.
...
2) For alle træningsdataeksempler udregnes $y^{(m)}$, $z^{(m)}$ og $o^{(m)}$ ved hjælp af feedforward-ligningerne:
