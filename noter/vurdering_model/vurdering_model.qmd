...
Sammenligner vi @fig-R2_1 og @fig-R2_2 ses det tydeligt, at i vores eksempel er den samlede kvadrerede fejl langt større for den naive model end for modellen baseret på lineær regression. 
...
$$
får vi et mål, som ikke er afhængig af datasættets størrelse. Det er **mean squared error (MSE)**. Endelig tager vi kvadratroden af det (for at få målet ned på samme skala, som vores $y$-værdier er på):
