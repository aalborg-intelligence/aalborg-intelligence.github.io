...
$$
får vi et mål, som ikke er afhængig af datasættets størrelse. Det er **mean squared error (MSE)**. Bemærk, at hvis for eksempel alle $y$-værdierne er målt i centimeter ($\mathrm{cm}$), da vil måleenheden for MSE være kvadratcentimeter ($\mathrm{cm}^2$). Derfor tager man kvadratroden af MSE for at få målet ned på samme skala, som vores $y$-værdier er på:
