...
description: "Her ser vi på et simpelt kunstigt neuralt netværk med to skjulte lag, men hvor hvert skjult lag kun består af én neuron. I dette simple tilfælde forklarer vi, hvad feedforward og backpropagation handler om, ligesom vi også kommer ind på træningsdata og tabsfunktion."
aliases: 
  - "/materialer/simple_neurale_net/simple_neurale_net.html"
from: markdown+emoji
---

Et generelt kunstigt neuralt netværk består af en masse neuroner, som er sat sammen i en række lag. Det kunne for eksempel se ud som i [@fig-long_NN]{.nolink}, hvor de grønne neuroner i midten repræsenterer de såkaldte skjulte lag. 
...
x_1, x_2, \dots, x_n.
$$
Disse inputvariable sender vi nu ind i et forholdsvis simpelt neuralt netværk, som vist i [@fig-long_simple_NN]{.nolink}.
...
\end{cases}
$$
Lad os derfor se på, hvordan $o$ kan beregnes. Det sker ved hjælp af en række vægte, som er repræsenteret ved pilene i [@fig-long_simple_NN]{.nolink}. Inputværdierne sendes frem til den første neuron (vist som en lysegrøn cirkel i [@fig-long_simple_NN]{.nolink}). Her beregnes den vægtede[^5] sum:
...
Idéen er illustreret i [@fig-sammensatfunktion]{.nolink}.
