...
aliases: 
  - "/materialer/sandsynlighed/sandsynlighed.html"
categories:
  - Note
---
...
Dette er illustreret i [@fig-AsubsetB]{.nolink}, som kaldes for et Venn-diagram.
...
som mængden, der netop indeholder de elementer, som er i $A$ [eller]{.underline} $B$ [eller]{.underline} begge af disse. Dette er illustreret i [@fig-AcupB]{.nolink}.
...
som mængden, der netop indeholder de elementer, som er indeholdt i [både]{.underline} $A$ [og]{.underline} $B$. Det er vist i [@fig-AcapB]{.nolink}.
...
Lad os se på et univers $U$ og en mængde $A$, som kun indeholder elementer, der også er i $U$. Vi vil så indføre komplementærmængden for $A$, som mængden indeholdende netop de elementer fra $U$, som [ikke]{.underline} er i $A$. Komplementærmængden til $A$ skrives $\overline{A}$. Dette er illustreret i [@fig-complementA]{.nolink}.
...
Et eksempel på en opdeling af en mængde $A$ i mængderne $A_1, A_2, A_3, A_4$ og $A_5$ ses i [@fig-opdeling]{.nolink}.
...
$$
De udfald, som er i hændelsen $A$, kalder man også for **gunstige udfald**. Det betyder, at ovenstående formel kan udtrykkes på denne måde:
...
Hvis man ser på hændelser som mængder, kan man ved hjælp af Venn-diagrammet i [@fig-AcupB2]{.nolink} se, at der må gælde
...
En klasse slår med en uærlig terning 234 gange og noterer det antal øjne, terningen viser. På den baggrund kan de estimere sandsynligheden for henholdsvis $1, 2, 3, 4, 5$ og $6$:
...
I @exm-eks13 er der ikke uafhængighed mellem hændelserne at \"den udvalgte er en dreng\" og hændelsen \"den udvalgte er interesseret i fodbold\". I eksemplet var $P(\textrm{ fodbold})=42\%$, mens $P(\textrm{ fodbold } | \textrm{ dreng})=60\%$.
...
Fra definitionen på betinget sandsynlighed (@def-betinget) ved vi, at
...
* [Test for sygdomme](../../undervisningsforlob/test_for_sygdomme.qmd){target="_blank"}
