...
aliases: 
  - "/materialer/afstande/AfstandeMellemDNA.html"
categories:
  - A-niveau
---

RNA er strenge med bogstaverne U (uracil), G (guanin), C (cytosin) og A
(adenin). DNA har ikke U, men i stedet T (thymin). DNA er typisk dobbeltstrenget, men afstandsberegningerne her foretages på enkeltstrenge. Bogstaverne U, G, C, A og T kaldes for nukleotider.

Vi ser her på afstande mellem to DNA-sekvenser (eller to RNA-sekvenser), som bygger på antallet af
mutationer for at nå fra den ene sekvens til den anden sekvens og desuden, hvor hyppige
...
*transitioner*[^1]. De fire andre mulige skift mellem A og C, A
og T, G og T eller G og C kaldes for *transversioner*.
...
$GATTACC$. Den slags udskiftning af et bogstav (en base) kaldes en
punktmutation.

*Indel* mutationer er indsætning (\"In\") eller fjernelse (\"del\" for
delete) af en eller flere baser. Det er mindre hyppige hændelser end punktmutationer og tildeles derfor en
...
-   Gap åbning: 9 (indsæt eller fjern præcis én base - altså et bogstav)

-   Gap forlængelse: 4 (indsæt eller fjern yderligere en base på samme sted, som allerede er
    åbnet)
...
$$AGT \to ATGT \to ATG$$ 
Det vil sige, indsæt $T$ mellem $A$ og $G$, hvilket koster $9$ og fjern så det sidste $T$, hvilket koster $4$. Det koster dermed samlet $9+4 =13$, så længden af denne vej er $13$. 
...
afstanden er $4$. At denne vej faktisk er den korteste, kræver mere eftertanke.
...
mulige pladser. Derefter udregner man afstande, men det er stadig ikke
nemt, bl.a. fordi der kan være flere forskellige måder at aligne på -- så der skal algoritmer til. 
...
* [Sammenligning af DNA-strenge](../../undervisningsforlob/DNA_strenge.qmd){target="_blank"}.
