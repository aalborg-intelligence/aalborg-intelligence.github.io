...
Et konkret eksempel: $p=(0,0)$, $q=(2,0)$, $r=(4,0)$. Se [@fig-ikke_metrik]{.nolink}.
...
$r=(4,0)$. Se [@fig-ikke_metrik2]{.nolink}.
...
Her regner vi på trekanter $pqr$ med: $p=(0,0)$, $q=(2,y)$ og $r=(4,0)$, hvor midterpunktet $q$ flyttes længere væk fra førsteaksen. Brug den interaktive figur nedenfor og find det $y$, hvor
$D(p,q)+D(q,r)=D(p,r)$. 
