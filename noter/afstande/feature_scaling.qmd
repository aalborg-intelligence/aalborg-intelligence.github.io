...
description: "Hvis de data, man arbejder med, måler vidt forskellige ting -- måske endda på vidt forskellige skalaer -- så vil man som oftest have brug for at \"justere\" data, så de er på samme skala. Det er præcis, hvad feature-skalering går ud på." 
aliases: 
  - "/materialer/afstande/feature_scaling.html"
categories:
  - A-niveau
---
...
Det er ikke altid helt klart, hvordan man skal bestemme afstanden mellem to datapunkter, hvis koordinaterne i hvert datapunkt beskriver vidt forskellige ting. Vi vil her se nærmere på, hvilke problemer der kan opstå, hvis man ikke tænker sig om -- og hvad man kan gøre for at løse dem.
...
| Person | (vægt, højde) |
|:-----:|:-----:|
| A | $(70 \textrm{ kg}, 165 \textrm{ cm})$ |
| B | $(90 \textrm{ kg}, 180 \textrm{ cm})$ |
| C | $(80 \textrm{ kg}, 190 \textrm{ cm})$ |
: {.bordered}
...
| Person | (vægt, højde) |
|:-----:|:-----:|
| A | $(70 \textrm{ kg}, 1.65 \textrm{ m})$ |
| B | $(90 \textrm{ kg}, 1.80 \textrm{ m})$ |
| C | $(80 \textrm{ kg}, 1.90 \textrm{ m})$ |
: {.bordered}
...
tilsyneladende som vinden blæser og afhænger af, hvilken enhed vi har valgt at måle i.
...
| Familie | (bolig, mælk) |
|:-----:|:-----:|
| A | $(7500 \textrm{ kr}, 200 \textrm{ kr})$ |
| B | $(7500 \textrm{ kr}, 1700 \textrm{ kr})$ |
| C | $(6000 \textrm{ kr}, 200 \textrm{ kr})$ |
: {.bordered}
...
$b$, mens $y$-værdierne ligger mellem[^minmax] $c$ og $d$. Situationen er illustreret i [@fig-min_max_skalering]{.nolink}.

[^minmax]: I eksemplet her er der på forhånd givet et interval, som vi ved, at $x$- og $y$-værdierne ligger i. I nogle tilfælde kender man ikke et sådant interval. Her vil man i stedet kunne bruge den mindste $x$-værdi i datasættet som $a$ og den største $x$-værdi som $b$. På tilsvarende vis kan $c$ og $d$ bestemmes ved at bruge henholdsvis minimum og maksimum af $y$-værdierne.   
...
Det får den betydning, at hvis $x$-værdierne for eksempel kan variere i et langt bredere interval end $y$-værdierne (dvs. at $b-a>d-c$), så bliver forskellen på $x$-værdierne i ovenstående afstandsmål skaleret mere ned (fordi vi kommer til at dividere med et større tal). 
...
Resultatet af at lave denne skalering af punkterne fra @fig-min_max_skalering ses i [@fig-min_max_skalering2]{.nolink}.
...
## Mindre naivt, mere bøvlet: Feature-skalering
...
Resultatet af at lave denne feature skalering af punkterne fra @fig-min_max_skalering ses i [@fig-feature_scaling]{.nolink}.
...
| B | $(7500 \textrm{ kr}, 1700 \textrm{ kr})$ |
| C | $(6000 \textrm{ kr}, 200 \textrm{ kr})$ |
| D | $(5200 \textrm{ kr}, 300 \textrm{ kr})$ |
| E | $(8100 \textrm{ kr}, 250 \textrm{ kr})$ |
| F | $(6200 \textrm{ kr}, 350  \textrm{ kr})$ |
| G | $(7700 \textrm{ kr}, 400 \textrm{ kr})$ |
| H | $(5800 \textrm{ kr}, 350 \textrm{ kr})$ |
| I | $(7200 \textrm{ kr}, 250 \textrm{ kr})$ |
| J | $(6800 \textrm{ kr}, 400  \textrm{ kr})$ |
: Udvidet eksempel om udgifter til bolig og mælk. {#tbl-bolig_milk .bordered}

Datapunkterne fra tabellen ses indtegnet i [@fig-bolig_milk_raw]{.nolink}. De tre første familier $A$, $B$ og $C$ fra det tidligere eksempel er markeret. Bemærk, at vi tidligere har beregnet, at afstanden mellem $A$ og $B$ er den samme som afstanden mellem $A$ og $C$, hvilket også fremgår af [@fig-bolig_milk_raw]{.nolink}.

![Datapunkterne fra eksemplet i [@tbl-bolig_milk]{.nolink} omkring udgifter til bolig og mælk.](images/fig_bolig_milk_raw.png){#fig-bolig_milk_raw}

Vi vil nu lave både min-max skalering samt feature skalering af punkterne i [@tbl-bolig_milk]{.nolink}. For at lave min-max skalering får vi brug for mindste- og størsteværdi for både $x$- (bolig) og $y$-værdierne (mælk). De er:
\begin{align}
a&=5200 \quad  &\text{og} \quad \quad &b=8100 \\
c&=200 \quad  &\text{og} \quad \quad &d=1700 \\
\end{align}
Bruges disse værdier samt formlerne i (@eq-norm) fås punkterne, som ses i [@fig-bolig_milk_min_max_skalering]{.nolink}.
...
Anvendes formlerne i (@eq-feature_scaling_x) og (@eq-feature_scaling_y) til feature skalering af punkterne i @tbl-bolig_milk fås punkterne, som ses i [@fig-bolig_milk_feature_skalering]{.nolink}.
...
* [Feature-skalering på data fra overvågningsforløb](../../undervisningsforlob/kNN_overvaagning_featureskalering.qmd){target="_blank"}.
