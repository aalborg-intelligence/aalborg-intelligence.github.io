...
Vi kan nu prøve at finde en plan i $\mathbb{R}^3$, der adskiller punkterne. Som før søger vi den plan, der har størst mulig afstand til det nærmeste punkt. Denne afstand vil vi igen kalde $M$. Den optimale plan i eksemplet [@fig-3D]{.nolink} er vist på [@fig-3Dplan]{.nolink}.
