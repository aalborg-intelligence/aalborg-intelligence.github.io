...
::: {.paddingleft}
![](funktioner_af_flere_variable/images/maskine2.png){style='float:right; margin-left:1rem;'  width=40%}
:::
...
![](gradientnedstigning/images/minMaxFunc.png){style='float:right; margin-left:1rem;'  width=40%}
...
![](sandsynlighed/images/AcupB2.png){style='float:right; margin-left:1rem;'  width=30%}
...
::: {.paddingleft}
![](afstande/images/fig_min_max_skalering.png){style='float:right; margin-left:1rem;'  width=40%}
:::
