...
description: "Her forklares hvad gradientnedstigning går ud på, og hvordan gradientnedstigning kan bruges i forbindelse med at bestemme minimum eller maksimum for en funktion."
aliases: 
  - "/materialer/gradientnedstigning/gradientnedstigning.html"
---
...
kan du vælge enten at læse et argument, som baserer sig på [geometriske argumenter](bevis_geometrisk_argument.qmd) eller et argument, som er baseret på [middelværdisætningen](bevis_vha_middelvaerdisaetningen.qmd).
...
og vælger vi i hvert skridt at lægge $-0.001$ gange den negative gradientvektor i punktet til, så kan nogle af de følgende $(x,y)$-punkter ses her:
...
Læg her mærke til, hvordan vi nærmer os det globale minimumssted i $(5,10)$. Herunder ses det også, hvordan vi ved hjælp af gradientnedstigning, nærmer os den globale minimumsværdi på $f(5,10)=45:$

$$
\begin{aligned}
&f(x_{0},y_{0}) = 2777 \\
\\
&f(x_{10},y_{10}) = 353.6444688 \\
\\
&f(x_{100},y_{100}) = 62.15929216 \\
\\
&f(x_{300},y_{300}) = 45.30642619 \\
\\
&f(x_{500},y_{500}) = 45.00592116 \\
\\
&f(x_{1000},y_{1000}) = 45.00000153\\
\end{aligned}
$$
...
### VIDEO: Gradientnedstigning

I videoen her ser vi på et eksempel på gradientnedstigning. Videoen bygger videre på [Funktioner af to variable 1: Introduktion og partielle afledede](https://youtu.be/tlq2UYWF2Rw), som du måske vil se først.
...
At lede efter et globalt minimumspunkt eller i det mindste et brugbart lokalt minimumspunkt for en funktion af rigtig mange variable er et problem, man står overfor, når man skal træne et neuralt netværk og have fastlagt et stort antal vægte i netværket.

Da problemet ikke kan løses analytisk, anvender man en iterativ proces baseret på gradientnedstigning til at finde minimumspunktet. Eksemplet ovenfor illustrerer derfor idéen bag en central del af træningen af et neuralt netværk.

Læs mere om, hvordan gradientnedstigning konkret bruges her: [Kunstige neuroner](../kunstige_neuroner/kunstige_neuroner.qmd), [Simple kunstige neurale netværk](../simple_neurale_net/simple_neurale_net.qmd), [Simple kunstige neurale netværk til multipel klassifikation](../softmax/softmax.qmd) og [Kunstige neurale netværk](../neurale_net/neurale_net.qmd).

## Relaterede forløb

* [Gradientnedstigning](../../undervisningsforlob/kunstige_neuroner_langt_forlob/kunstige_neuroner_del2.qmd){target="_blank"} (en del af et langt forløb om kunstige neuroner).
