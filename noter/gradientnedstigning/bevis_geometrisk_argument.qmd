...
aliases: 
  - "/materialer/gradientnedstigning/bevis_geometrisk_argument.html"
---
...
Dette er illustreret i [@fig-plan_parallel_zakse]{.nolink}, hvor man ved at trække i skyderen kan ændre på den retning, $\vec u$ peger i.
...
Det er disse planer, vi snitter grafen for $f$ med. Et eksempel er vist i [@fig-snitfkt]{.nolink}. Ved at trække i skyderen kan man igen ændre på planen, som er parallel med $z$-aksen.
...
Nu er det sådan at *hvis* tangenterne til alle snitkurverne ligger i en plan, så kaldes denne plan for **tangentplanen**. Et eksempel herpå ses i [@fig-tangentplan]{.nolink}. Her er det tydeligt, at de indtegnede tangenter alle ligger i den samme plan.
