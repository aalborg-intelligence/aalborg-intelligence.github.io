...
aliases: 
  - "/materialer/gradientnedstigning/bevis_vha_middelvaerdisaetningen.html"
---
...
På [@fig-middelvaerdisaetningen]{.nolink} illustreres dette princip.
:::
...
\end{aligned}
$$ 
Bemærk, at vi har lagt et led til og trukket det samme led fra (markeret med rødt). Det svarer til, at vi har indskudt et punkt i $xy$-planen, som illustreret i [@fig-punkt_indskudt1]{.nolink}.
...
Afvigelsen på henholdsvis $x$- og $y$-koordinaten er vist i [@fig-punkt_indskudt2]{.nolink}.
...
Her har vi brugt, at den afledede af en snitfunktion, hvor vi kun varierer $x$ er $f_x$, og den afledede af en snitfunktion, hvor vi kun varierer $y$ er $f_y$. Tallet $c_{1}$ ligger mellem $x_{0}$ og $x_{0} + h \cdot u_{1}$, og tallet $c_{2}$ ligger mellem $y_{0}$ og $y_{0} + h \cdot u_{2}$. Dette er vist i [@fig-punkt_indskudt3]{.nolink}.
