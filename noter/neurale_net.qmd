---
title: "Noter om kunstige neurale netværk"
description: "Forskellige noter -- med varierende fokus og sværhedsgrad -- om kunstige neurale netværk."
image: "simple_neurale_net/images/long_simple_NN.png"
aliases: 
  - "/materialer/neurale_net.html"
---
...
Helt overordnet kan man sige, at et neuralt netværk er en funktion, der tager et antal målte variable som input. Det kunne for eksempel være en vælgers svar på en kandidattest. Som output giver det en klasse/kategori, for eksempel et parti vælgeren bør stemme på. I et neuralt netværk indgår nogle ikke-lineære funktioner kaldet [aktiveringsfunktioner](../undervisningsforlob/aktiveringsfunktioner.qmd), som i sig selv er matematisk interessante. For at finde et neuralt netværk, der giver gode klassifikationer, minimeres en [tabsfunktion](tabsfunktioner/tabsfunktioner.qmd). Til det formål får man brug for at finde partielt afledte, som bruges i forbindelse med [gradientnedstigning](gradientnedstigning/gradientnedstigning.qmd). 

Historisk set startede man med såkaldte perceptroner, som vi har en note om [her](perceptron/perceptron.qmd), men vi anbefaler egentligt at bruge sit krudt på at dykke ned i en eller flere af nedenstående noter. 
...
<!-- ::: {.paddingleft} -->
<!-- ![](perceptron/images/perceptron.png){style='float:right; margin-left:1rem;'  width=40%} -->
<!-- ::: -->

<!-- Noten beskriver først \"Perceptron Learning Algoritmen\", som kan bruges i forbindelse med binær klassifikation, men som kun konvergerer, hvis data er lineært separable. Der gives ikke noget matematisk argument for dette, men det sandsynliggøres, hvorfor algoritmen virker. I behandlingen af  \"Perceptron Learning Algoritmen\" anvendes der ikke eksplicit en tabsfunktion.   -->

<!-- Dernæst beskrives algoritmen \"ADALINE\", som også bruges til binær klassifikation, men som konvergerer -- også i det tilfælde, hvor data ikke er lineært separabel. Opdateringsreglerne til ADALINE algoritmen udledes ved at minimere *squared error* tabsfunktionen ved hjælp af gradientnedstigning. Den anvendte aktiveringsfunktion er her identiteten, hvilket gør denne udledning lettere end i de efterfølgende noter. -->
...
::: {.paddingleft}
![](kunstige_neuroner/images/simplet_netvaerk2.png){style='float:right; margin-left:1rem;'  width=40%}
:::
...
| Type | Aktiveringsfunktion | Tabsfunktion | 
|:---:|:---:|:---:|
| Binær klassifikation | Sigmoid | *Squared error* | 
: {.bordered}
...
::: {.paddingleft}
![](simple_neurale_net/images/long_simple_NN.png){style='float:right; margin-left:1rem;'  width=40%}
:::
...
::: {.paddingleft}
![](softmax/images/netvaerk_generelt.png){style='float:right; margin-left:1rem;'  width=25%}
:::
...
| Type | Aktiveringsfunktion | Tabsfunktion |
|:---:|:---:|:---:|
| Multipel klassifikation | Softmax | *Cross-entropy* | 
: {.bordered}
...
<a href="simple_neurale_net_regression/simple_neurale_net_regression.html" class="quarto-grid-link">
...
::: {.paddingleft}
![](simple_neurale_net_regression/images/neuralt_net_regression.png){style='float:right; margin-left:1rem;'  width=25%}
:::

Noten handler om, hvordan man kan bruge en kunstig neuron og et kunstigt neuralt netværk med skjulte lag til at prædiktere en numerisk værdi. Når en kunstig neuron anvendes til prædiktion af numeriske værdier svarer det til multipel lineær regression, mens et kunstigt neuralt netværk er en udvidelse heraf. I de kunstige neurale netværk indføres skjulte lag, hvor **ReLu** bruges som aktiveringsfunktion.


| Type  | Aktiveringsfunktion | Tabsfunktion |
|:---:|:---:|:---:|
| Regression | ReLu | *Squared error* | 
: {.bordered}
...
::: {.paddingleft}
![](neurale_net/images/simple_NN_weights.png){style='float:right; margin-left:1rem;'  width=40%}
:::
...
| Type | Aktiveringsfunktion | Tabsfunktion | 
|:---:|:---:|:---:|
| Primært binær klassifikation | Sigmoid | *Squared error* | 
: {.bordered}
