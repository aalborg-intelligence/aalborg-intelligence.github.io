...
description: "Denne note giver en grundig gennemgang af matematikken bag kunstige neurale netværk."
aliases: 
  - "/materialer/neurale_net/neurale_net_helt_generelt.html"
...
I denne note vil vi se på, hvordan man kan udvide det neurale netværk, vi så på i [noten om neurale netværk](neurale_net.qmd){target="_blank"} til et netværk med et vilkårligt antal skjulte lag.

# Fra bogstaver til indekser {#sec-bogstaver_til_indekser}

Det står på nuværende tidspunkt nok klart for de fleste, at den
notation, som vi har anvendt i [noten om neurale netværk](neurale_net.qmd){target="_blank"}, er en lille smule
...
Lad os se på netværket i [@fig-netvaerk3]{.nolink}. Dette netværk har $3$ outputværdier i stedet for
...
a_3^{(2)}
$$ 
Det vil altså sige, at det tal, som står hævet i parentesen[^1], refererer til laget og det tal, som er sænket, refererer til nummeret på rækken i det givne lag.
...
bias. Der er tradition for, at man navngiver vægtene, som det ses på [@fig-w_jik]{.nolink}.
...
$$ 
Se også hvordan det passer med [@fig-w_jik]{.nolink}.
...
Vi forestiller os nu, at vi har $K$ lag i netværket, som det er illustreret på [@fig-generelt_netvaerk]{.nolink}. 
