...
plot(dat$pris_mio,pred, xlim=c(0,7.5), ylim=c(0,7.5), xlab="Lejlighedspris i millioner", ylab="Prædikteret pris", col="#020873", col.lab="#020873", col.axis="#020873", col.main="#020873")
box(col="#020873")
...
## Neuralt netværk - ét skjult lag med 10 neuroner
set.seed(42)
...
## Plot
par(mfrow = c(1, 2))
# To plots ved siden af hinanden
oma = c(4, 4, 2, 1)
# Kunstig neuron
plot(dat$pris_mio,pred_lm, xlim=c(0,7.5), ylim=c(0,7.5), xlab="", ylab="", main="Kunstig neuron", col="#020873", col.lab="#020873", col.axis="#020873", col.main="#020873")
box(col="#020873")
abline(0,1, col="#8085F2")
# NN 10
plot(dat$pris_mio,pred_nn10, xlim=c(0,7.5), ylim=c(0,7.5), xlab="", ylab="", main ="Neuralt netværk", col="#020873", col.lab="#020873", col.axis="#020873", col.main="#020873")
box(col="#020873")
abline(0,1, col="#8085F2")
# Fælles labels
mtext("Lejlighedspris i millioner", side = 1, line = 2, outer = TRUE)
mtext("Prædikteret pris", side = 2, line = 2, outer = TRUE)
```
