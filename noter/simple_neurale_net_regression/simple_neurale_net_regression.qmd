...
Vi ser også, at $w_2=-0.0023493$, som betyder, at hvis vi står med to lige store lejligheder, hvor den ene er præcis et år ældre end den anden, så vil salgsprisen på den ældste lejlighed ifølge modellen være $2349$ kroner lavere.
...
```{r}
#| fig-cap: Den prædikterede lejlighedspris (i millioner), som funktion af lejlighedens areal ($x_1$) og alder ($x_2$). Den prædikterede pris er her baseret på en kunstig neuron.
...
I @fig-pred_NN10 herunder er den prædikterede pris baseret på et neuralt netværk med et skjult lag med ti neuroner. 

```{r}
#| fig-cap: Den prædikterede lejlighedspris (i millioner), som funktion af lejlighedens areal ($x_1$) og alder ($x_2$). Den prædikterede pris er her baseret på et neuralt netværk med et skjult lag med ti neuroner.
#| label: fig-pred_NN10
#| out-width: 95%
#| fig-height: 7
pp |> 
...
Det ses tydeligt, at det neurale netværk er bedre til at prædiktere lejlighedspriserne for de nyeste lejligheder med et forholdsvis stort areal sammenlignet med den kunstige neuron.
