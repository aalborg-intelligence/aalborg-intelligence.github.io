...
Vi har trænet et kunstigt neuralt netværk med ét skjult lag med henholdsvis to og ti neuroner. Det kan man gøre ved at bruge [Neuralt netværk app til regression](https://apps01.math.aau.dk/ai/nn-regression/). Vi har her valgt henholdsvis $2$ og $10$ neuroner i det første skjulte lag og $0$ i det andet skjulte lag. Learning rate er sat til $0.0001$, antal iterationer til $1000$ og ReLu er valgt om aktiveringsfunktion i de skjulte lag.
