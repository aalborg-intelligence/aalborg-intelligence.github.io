...
Vi søger nu de værdier af $w_0$ og $w_1$, som minimerer tabsfunktionen. Bruges gradientnedstigning (du kan selv prøve ved at bruge [app'en](https://apps01.math.aau.dk/ai/neuron/) vælg blot \"Identitet\" som aktiveringsfunktion under fanen \"Træning\") her fås[^1]:
...
Vi søger nu igen de værdier af $w_0$ og $w_1$, som minimerer tabsfunktionen. Bruges gradientnedstigning (du kan selv prøve ved at bruge [app'en](https://apps01.math.aau.dk/ai/neuron/) vælg blot \"Identitet\" som aktiveringsfunktion under fanen \"Træning\") her fås[^3]:
