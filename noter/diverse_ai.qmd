---
title: "Øvrige AI noter"
description: "Forskellige noter -- med varierende fokus og sværhedsgrad -- om forskellige andre AI metoder (end neurale net og sprogmodeller)."
aliases: 
  - "/materialer/diverse_ai.html"
image: "ROC/images/confusion_matrix.png"
---


På denne side finder du øvrige AI noter, som ikke er dækket i de forskellige noter om neurale net og sprogmodeller. Noterne varierer i sværhedsgrad og i matematisk fokus. 
...
<a href="anbefalinger/anbefalinger.html" class="quarto-grid-link">

::: {.boxed}

### Anbefalingssystemer

![](anbefalinger/images/film.jpg){style='float:right; margin-left:1rem;'  width=40%}
...
![](logistisk/data/figur_til_www_files/figure-html/log_reg_www-1.png){style='float:right; margin-left:1rem;'  width=40%}
...
<a href="SVM/SVM.html" class="quarto-grid-link">

::: {.boxed}

### Support Vector Machines

![](SVM/images/fig-margin-1.png){style='float:right; margin-left:1rem;'  width=40%}

Support Vector Machines er en metode inden for kunstig intelligens, der kan bruges til at adskille forskellige grupper fra hinanden. Hvis der for eksempel er to grupper, så er idéen at repræsentere hver gruppe som et punkt og dernæst at tegne en linje, som adskiller de to grupper. Support vector machines vælger den linje, der har størst mulig afstand til den nærmeste observation.
...
![](tabsfunktioner/images/tabsfunktion.jpg){style='float:right; margin-left:1rem;'  width=30%}
:::
...
![](krydsvalidering/images/overfitting.png){style='float:right; margin-left:1rem;'  width=25%}
...
<a href="vurdering_model/vurdering_model.html" class="quarto-grid-link">

::: {.boxed}

### Mål for en models nøjagtighed

![](vurdering_model/images/R2_1.png){style='float:right; margin-left:1rem;'  width=40%}
...
![](ROC/images/confusion_matrix.png){style='float:right; margin-left:1rem;'  width=40%}
...
![](naivbayes/images/bayes_thm.png){style='float:right; margin-left:1rem;'  width=40%}
...
![](kmeans/images/kmeansbil.jpg){style='float:right; margin-left:1rem;'  width=40%}
