...
aliases: 
  - "/materialer/sprogmodeller/word2vec-bog.html"
---
...
library(plotly)
library(dplyr)
est <- readRDS(here::here("noter", "sprogmodeller", "data", "word2vec_estimates_reg.rds"))
type_fun <- function(x) {
  switch(x,
         "ko" = "dyr",
         "hest" = "dyr",
...
<https://aimat.dk/noter/sprogmodeller/data/bog.txt>
