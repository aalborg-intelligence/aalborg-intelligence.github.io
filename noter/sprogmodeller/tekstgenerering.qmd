...
description: "Denne note handler om, hvordan de vektorer, som repræsenterer hvert enkelt ord i vores ordforråd, kan bruges som input i et kunstigt neuralt netværk, der kan bruges til at prædiktere det næste ord i en sætning."
aliases: 
  - "/materialer/sprogmodeller/tekstgenerering.html"
---
...
så laver vi en datatabel[^3] som i [@tbl-data]{.nolink}.
...
som muligt. Dette er illustreret i [@fig-natural_ln]{.nolink}, hvor vi tegnet grafen for den naturlige logaritme-funktion samt grafen for minus den naturlige logartime-funktion (husk på at $0<z_c<1$):
...
af [gradientnedstigning](../gradientnedstigning/gradientnedstigning.qmd){target="_blank"}. For at lave
...
*backpropagation*. Et simpelt eksempel på backpropagation findes i noten om [simple neurale net](../simple_neurale_net/simple_neurale_net.qmd){target="_blank"}.
