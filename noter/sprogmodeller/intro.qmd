...
description: "Sprogmodeller skal kunne håndtere sprog. I denne note giver vi en kort introduktion til, hvordan det fungerer på et helt overordnet plan."
aliases: 
  - "/materialer/sprogmodeller/intro.html"
from: markdown+emoji
---
...
Sprogmodellen gætter så på et af de mest sandsynlige ord som det næste. Et eksempel kan ses i [@tbl-pred]{.nolink}. Her kan man se, at \"skoven\" og \"byen\" er gode bud på det næste ord i sætningen \"Jeg går en tur i\".
...
I noten om [Simple sprogmodeller](simple.qmd) ser vi på, hvordan man lidt
...
[Tekstgenerering med neurale netværk](tekstgenerering.qmd). 

Den form for neuralt netværk, som benyttes i Chat-GPT og andre generative AI-programmer kaldes **transformeren**. Transformeren kombinerer idéerne fra [Word2Vec](word2vec.qmd) og neurale netværk. Du kan læse om de væsentligste principper bag [transformeren i denne note](transformeren.qmd).

## VIDEO: Introduktion 

I videoen her giver vi en introduktion til store sprogmodeller.
