...
description: "I denne note vil vi beskrive et helt simpelt -- og naivt -- bud på en sprogmodel. Selvom modellen, som præsenteres her, er for simpel, giver den alligevel en god forståelse for den grundlæggende idé bag de store sprogmodeller."
aliases: 
  - "/materialer/sprogmodeller/simple.html"
---
...
[@tbl-hyp_bigram]{.nolink} nedenfor er der lavet en hyppighedstabel over alle bigram i
vores tekst. Vi lader som om, teksten starter forfra, så det sidste
\"hund\" efterfølges af \"En\".

::: {#tbl-hyp_bigram .bordered}
...
{{< include simple_trigram_tabel.qmd >}}
...
### VIDEO: N-gram sprogmodeller 

I videoen her forklarer vi om N-gram sprogmodeller.
...
på, hvordan det kan gøres, er den algoritme, som kaldes for [Word2Vec](word2vec.qmd){target="_blank"}. Kort fortalt er idéen at repræsentere hvert ord med en vektor, hvor ord, hvis betydning minder om hinanden, svarer til vektorer, med nogenlunde samme retning og
længde. Et konkret eksempel på det ses i [@fig-vektorer2]{.nolink}.

{{< include _geogebra/_geogebra.qmd >}}

::: {#fig-vektorer2 width=80% fig-align='center'}
...
Når vi har lavet vektorrepræsentationer af alle ord i sproget, skal vi bruge dem til at lave prædiktioner af næste ord ud fra de foregående. Til det kan man benytte en form for [tekstgenerering med neurale netværk](tekstgenerering.qmd){target="_blank"}. I praksis bruges dog en [transformer](transformeren.qmd){target="_blank"}, som er endnu mere avanceret, og som i praksis er den sprogmodel, der virker bedst til tekstgenerering.
