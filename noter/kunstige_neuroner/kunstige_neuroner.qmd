...
og grafen ses i [@fig-sigmoid]{.nolink}.
...
Vi vil gerne have, at sigmoid-funktionen på en eller anden måde afhænger af vores inputværdier $x_1$ og $x_2$. Det kan man gøre på mange måder, men en ofte anvendt metode er, at \"sende\" en linearkombination[^4] af inputværdierne ind i sigmoid-funktionen, så outputværdien $o$ beregnes sådan her:

[^4]: En linearkombination af $x_1$ og $x_2$ betyder bare en vægtet sum: $w_0 + w_1 \cdot x_1 + w_2 \cdot x_2$, hvor $w_0, w_1$ og $w_2$ er konstanter.
...
I videoen herunder giver vi en introduktion til kunstige neuroner.


{{< video https://www.youtube.com/embed/OHFhWwe2AuQ >}}


Altså: Vi vil gerne bestemme nogle værdier af vægtene $w_0$, $w_1$ og $w_2$, så vores kunstige neuron bliver god til at forudsige, om et tilbud aktiveres eller ej. Det er her, at træningsdata kommer i spil, fordi vi for en lang række af inputværdier $x_1$ og $x_2$ jo faktisk  ved, om tilbuddet  blev aktiveret eller ej (husk på at den oplysning er gemt i targetværdien $t$). 
...
### VIDEO: Træningsdata og tabsfunktion

I videoen her forklarer vi om træningsdata og tabsfunktionen.
...
Tabsfunktionen er en [funktion af flere variable](../funktioner_af_flere_variable/funktioner_af_flere_variable.qmd). I princippet kan man bestemme minimum ved at sætte alle de partielle afledede lig med $0$, løse ligningerne og dernæst overbevise sig selv om, at man har fundet et minimum. Det vil give et ligningssystem med $n+1$ ligninger, som alle er koblet med hinanden. Det viser sig, at være en beregningsmæssig tung opgave at løse dette ligningssystem analytisk. Derfor bruger man i stedet for den metode, som kaldes for [gradientnedstigning](../gradientnedstigning/gradientnedstigning.qmd). Gradientnedstigning går ud på først at vælge tilfældige værdier af vægtene $w_0, w_1, \cdots, w_n$. Det viser sig så, at den negative gradient vil pege i den retning, hvor funktionsværdien falder mest. Derfor er idéen at bevæge sig et lille stykke i den negative gradients retning -- fordi vi så kommer lidt tættere på minimum. Når vi har gjort det, beregner vi gradienten igen, og bevæger os igen et lille stykke i den negative gradients retning. Det forsætter vi med indtil værdien af tabsfunktionen ikke ændrer sig særlig meget, hvilket svarer til, at vi har fundet minimum. 
...
### VIDEO: Opdateringsregler

I videoen her udleder vi ovenstående opdateringsregler.
...
$$
Det er lige præcis ligningen for en ret linje i et $(x_1,x_2)$-koordinatsystem. I vores eksempel kan man finde vægtene ved hjælp af gradientnedstigning ved at bruge [Kunstig neuron app'en](https://apps01.math.aau.dk/ai/neuron/). Hvis vi i app'en sætter startvægtene til $0$, vælger en learning rate på $0.001$ og sætter antal iterationer til $10000$,  så ender vi med[^w2]

[^w2]: Vær opmærksom på, at selvom værdien af $w_2$ er meget mindre end $w_1$, så betyder det ikke nødvendigvis, at $x_2$ (forbruget) ikke er vigtig, når man skal prædiktere, om en kunde aktiverer et tilbud eller ej. Det skyldes, at forbruget har meget større værdier ($0-5000$ kroner) end alder ($10-80$ år). 


$$
w_0 = -0.7376, \quad  w_1 = -0.142 \quad \textrm{ og } \quad  w_2=0.002806
$$
Det giver ligningen
$$
-0.7376 - 0.142\cdot x_1 + 0.002806 \cdot x_2=0
$$
hvilket også kan omskrives til

$$
x_2 = 50.6 \cdot x_1 + 263
$$
...
Det vil nu være sådan, at for alle punkter $(x_1,x_2)$, som ligger over linjen i [@fig-alder_vs_forbrug2]{.nolink}, vil
...
$$
o = \sigma (-0.7376 - 0.142\cdot x_1 + 0.002806 \cdot x_2) > 0.5.
$$
...
Sig hej til kunderne Hans og Gerda, som lige har downloadet Good Foods app. 

![](images/hans_og_gerda.png){fig-align='center' width='60%'}

Hans er 50 år og har et forbrug på 3500 kroner. Gerda er derimod 65 år og med et forbrug på 2800 kroner. 

Vi vil nu beregne outputværdien $o$ for hver af de to kunder. Det gør vi ved at indsætte i:
$$
o = \sigma (-0.7376 - 0.142\cdot x_1 + 0.002806 \cdot x_2).
$$
Da får vi
$$
\begin{aligned}
&\textrm{Hans:} \quad  &o=\sigma (-0.7376 - 0.142\cdot 50 + 0.002806\cdot 3500) = 0.879 \\
&\textrm{Gerda:} \quad &o=\sigma (-0.7376 - 0.142\cdot 65 + 0.002806\cdot 2800) = 0.108
\end{aligned}
$$

Ifølge vores model er der altså en sandsynlighed på $87.9 \%$ for, at Hans vil aktivere tilbuddet, mens den tilsvarende sandsynlighed for Gerda er på $10.8 \%$. Vores bedste bud vil derfor være at prædiktere, at Hans vil aktivere tilbuddet, mens Gerda ikke vil. Vi vælger derfor at vise det pågældende tilbud til Hans, men ikke til Gerda.
...
Forskellen på ADALINE og kunstige neuroner er altså, at aktivieringsfunktionen i ADALINE er identiteten, mens den for kunstige neuroner er sigmoid-funktionen. Den helt store fordel ved det, kan du læse mere om i noten [Hvorfor er kunstige neuroner smartere end ADALINE?](smartere_end_adaline.qmd).
...
* [Kunstige neuroner](../../undervisningsforlob/kunstige_neuroner_langt_forlob/kunstige_neuroner_forside.qmd){target="_blank"} (langt forløb).
...
* [Lever du bæredygtigt?](../../undervisningsforlob/lever_du_baeredygtigt.qmd){target="_blank"}
* [Screeningsprogrammer](../../undervisningsforlob/screeningsprogrammer.qmd){target="_blank"}. 
* [AI og rødder i andengradspolynomier](../../undervisningsforlob/polynomium.qmd){target="_blank"}.
* [Opdatering af vægte i en kunstig neuron](../../undervisningsforlob/opdatering_af_vaegte/opdatering_af_vaegte_i_en_kunstig_neuron.qmd){target="_blank"}.
