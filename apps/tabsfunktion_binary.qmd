...
Her kan vælges den **tabsfunktion**, som minimeres. **Squared** svarer til  [squared error tabsfuntkionen](/noter/tabsfunktioner/tabsfunktioner.qmd#squared-error-tabsfunktionen){target="_blank"}, som måler summen af de kvadrerede fejl:
...
Uanset hvilken tabsfunktion man vælger, skal man være opmærksom på, at gradientnedstigning konvergerer. Det ses ved, at grafen for tabsfunktionen i højre side af skærmen flader ud.
