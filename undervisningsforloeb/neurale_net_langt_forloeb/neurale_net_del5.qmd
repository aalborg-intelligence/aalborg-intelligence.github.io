...
- Udfyld nedenstående tabel. 
   ...
   *Forklaring: Med __CA (på træningsdata)__ menes den værdi for klassifikationsnøjagtigheden, som       man får, når man bruger samme datasæt til både at træne og teste på (denne værdi kan ses øverst      til højre i app'en). Med __CA1-CA5__ menes de værdier af klassifikationsnøjagtigheden, som man       får, når man kører app'en fem forskellige gange uden af ændre på indstillingerne.* 
