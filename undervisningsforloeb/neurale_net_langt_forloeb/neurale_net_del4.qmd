...
- Start med at kopiere den første halvdel af datasættet over i et regneark i GeoGebra svarende til data for alle kvinderne, det vil sige hvor \"kon=1\" (heldigvis er datasættet sorteret efter \"kon\", så det er lige til at gå til).
...
- Indsæt nogle tekstfelter i tegneblokken (tryk på ikonet \"Skyder\" og vælg \"Tekst\"), så du får angivet, hvad der er ud af akserne, hvad de røde og blå punkter betyder, og at plottet er for kvinder.

- Vil du i dette koordinatsystem kunne indlægge en rette linje, som (for de fleste punkter) vil kunne bruges til at adskille de blå punkter fra de røde? Notér ligningen for en sådan linje.
...
$$
o = \frac{1}{1+\mathbb{e}^{-(w_0+w_1 \cdot x_1+w_2 \cdot x_2+w_3 \cdot x_3)}}
$$
...
- Ser det ud som om, at vi ved den sidste iteration har fundet minimum for tabsfunktionen (flader grafen ud eller er den stadig \"på vej nedad bakke\")?

- Prøv at sætte antal iterationer til $10000$ (det tager lige lidt længere tid). Tænker du, at vi har fundet minimum nu?

- Notér værdien af vægtene $w_0$, $w_1$, $w_2$ og $w_3$, som står i tabellen ovenfor grafen for tabsfunktionen i højreside.

- Notér slutværdien af tabsfunktionen (som står lige under grafen).
...
Brug de vægte som du fandt i opgave 3.

- Brug de plots som du lavede i opgave 2 og indtegn de rette linjer med ligningerne i (@eq-linje2) (selvfølgelig skal du tegne linjen for kvinder i det plot du lavede for kvinder og tilsvarende med mændene).
...
I aktivitet 2 i [del 3](neurale_net_del3.qmd) så vi, at man kan starte et sted på grafen for tabsfunktionen, som resulterer i \"slow learning\". Det vil sige, at det kan umiddelbart se ud som om, at man har fundet et minimum for tabsfunktionen, men i virkeligheden er man landet i et plateau eller lignede sted, hvor værdien af tabsfunktionen kun ændrer sig langsomt.
...
- Tryk på \"Kør!\". Ser det ud som om, at vi har fundet et minimum?

- Sæt antal iterationer op til $10000$. Er det bedre?

- Prøv med $35000$ (og hav lidt tålmodighed -- det tager lidt tid). Ser det ud som om, at vi har fundet minimum nu? Notér klassifikationsnøjagtigheden (CA) i dette tilfælde.

- Sæt antal iterationer op til $100000$. Er det bedre? Notér CA.

- Sæt antal iterationer op til $200000$. Notér CA.

- Notér nu værdien af vægtene $w_0$, $w_1$, $w_2$ og $w_3$, som står i tabellen ovenfor grafen for tabsfunktionen i højreside.

- Notér slutværdien af tabsfunktionen (som står lige under grafen). Sammenlign med slutværdien af tabsfunktionen, som du fandt i opgave 3.
