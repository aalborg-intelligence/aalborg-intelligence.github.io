---
title: "Opdatering af vægte i et neuralt netværk med ét skjult lag"
...
Dette forløb ligner [forløbet om opdatering af vægte i neuralt netværk med to skjulte lag](../undervisningsforloeb/Opdatering_af_vægte_i_NN_med_2_skjulte_lag.qmd){target="_blank"}, men er lidt sværere, da man desuden skal modificere nogle elementer i forhold til noten om simple neurale netværk.
...
Formålet med dette forløber er gennem detaljerede beregninger at forstå, hvordan vægtene i et neuralt netværk til klassifikation med ét skjult lag opdateres med brug af sigmoid aktiveringsfunktionen og gradientnedstigning med *cross-entropy* som tabsfunktion.
...
* Udregn 
   ...
   ved hjælp af opdateringsreglen for hver af de 3 træningseksempler.
