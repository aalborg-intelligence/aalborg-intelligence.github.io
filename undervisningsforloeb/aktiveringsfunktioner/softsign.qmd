...
![Grafen for $|x|$.](/undervisningsforloeb/aktiveringsfunktioner/numerisk_x.png){width=75% #fig-numerisk_x}

Grafen for softsign-funktionen $f$ ses i @fig-softsign.

![Grafen for softsign-funktionen.](/undervisningsforloeb/aktiveringsfunktioner/softsign.png){width=75% #fig-softsign}
