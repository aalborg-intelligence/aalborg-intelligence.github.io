...
Metoden er, at man opløfter tallet $\mathrm{e}$ i hvert pointtal, og derefter regne sandsynlighederne på samme måde som før.
...
* Udregn sandsynlighederne for hver af de 3 andre typer boxmadrasser med Softmax metoden.
* Læg sandsynlighederne sammen og se, at det giver 1.
...
I mange anvendelser med Softmax indgår der derfor andre ting, så dette ikke er et problem, men det kan du måske komme til i 2.g eller 3.g. f.eks. i [Simple kunstige neurale netværk til multiple klassifikation](/materialer/softmax/softmax.qmd) eller [WordToVec](/materialer/sprogmodeller/word2vec.qmd).
