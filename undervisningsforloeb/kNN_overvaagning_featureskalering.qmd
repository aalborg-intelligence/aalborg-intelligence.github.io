...
* Vurder, hvilke $6$ punkter, der ligger tættet på det grå punkt, evt. ved at tilføje en cirkel med centrum i det grå punkt med en radius, så $6$ af de øvrige punkter ligger i cirklen.
...
* Vurder igen, hvilke $6$ punkter, der ligger tættet på det grå punkt, evt. vha. en cirkel.
...
F.eks. bruger programmet Orange, som du anvendte i forløbet [Overvågning i Monitorbian](kNN_forlob_overvaagning.qmd) denne form for featureskalering.
