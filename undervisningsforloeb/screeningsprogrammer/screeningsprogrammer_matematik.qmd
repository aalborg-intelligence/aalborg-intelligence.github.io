...
- Hvorfor er en klassifikationsnøjagtighed på $0.8$ ikke imponerende, og hvad svarer det til?

- Hvad er den højeste klassifikationsnøjagtighed, som I kan nå?
...
- Hvad kan du konkludere på baggrund af disse boksplots? 
...
- Brug det kunstige neurale netværk som I fandt frem til i den foregående aktivitet.

Vi forestiller os nu, at sundhedsmyndighederne stiller dette [valideringsdatasæt]() til rådighed.

*Screencast som viser hvordan man laver prædiktioner med brug enten af app eller af Orange.* 

- Brug jeres kunstige neurale netværk (trænet på jeres eget træningsdata) til at prædiktere om patienterne i valideringsdatasættet er syge eller raske. 
...
- Gentag aktivitet 2 og 4 for disse data. Kan I ramme en højere eller lavere klassifikationsnøjagtighed? Overvej hvorfor det forholder sig sådan.
