...
Politiet har taget syv forskellige [fingeraftryk](opklar_et_mord_filer/Træningsdata.zip) fra hver elev (data stammer fra [FVS2000 - Fingerprint Verification Competition](http://bias.csr.unibo.it/fvc2000/download.asp){target=”blank”}). På skolen har man i forskellige lokaler også fundet [fingeraftryk](opklar_et_mord_filer/Testdata.zip) - man ved bare ikke, hvem fingeraftrykkene stammer fra. 
