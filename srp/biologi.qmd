...
I matematik redegøres der for [logistisk regression](../noter/logistisk/log-reg.qmd) -- herunder hvordan denne metode kan benyttes til at prædiktere sygdom ved en person ud fra information fra et større datasæt. Desuden forklares idéen bag maksimum likelihood, og hvordan parametrene i modellen estimeres.
