...
Hvis man ønsker at arbejde med kunstige neurale netværk i en eller anden form, har vi samlet alle vores [noter om kunstige neurale netværk her](../noter/neurale_net.qmd). Der er -- som det også er beskrevet -- forskellige noter med forskelligt fokus og sværhedsgrad. Her er forslag til forskellige formuleringer:
...
En anden oplagt mulighed er at lade eleverne arbejde med store sprogmodeller. Vi har samlet alle vores [noter om sprogmodeller her](../noter/sprogmodeller.qmd). Vi anbefaler, at eleven arbejder dybdegående med en udvalgt del af materialet, fordi det ellers hurtigt bliver for komplekst. Her er forslag til konkrete formuleringer:
...
Vi har samlet en række [øvrige AI emner her på siden](../noter/diverse_ai.qmd), som også fint kan danne udgangspunkt for en SRP. Det drejer sig blandt andet om anbefalingssystemer, logistisk regression, krydsvalidering, naiv Bayes klassifier, clustering med K-means med mere.
...
Det kan være, at eleverne selv har indsamlet data, og ellers er der et væld af datasæt til eksempelvis binær klassifikation på [kaggle.com](https://www.kaggle.com/datasets?tags=14201-Binary+Classification).
...
Nogle af forslagene er beskrevet i alle detaljer, mens andre blot er skitserede. Desuden er nogle af opgaverne tænkt til den fagligt meget stærke elev, men det kan jo reduceres efter behov, mens andre opgaver skal tilføjes mere konkrete krav om specifik teori og/eller beregninger på små datasæt eller implementering og træning af større modeller på større datasæt.
