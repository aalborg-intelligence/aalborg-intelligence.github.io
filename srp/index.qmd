...
Hvis eleverne arbejde med konkrete datasæt, kan de træne et kunstigt neuralt netværk ved hjælp af [en af vores apps](../apps/index.qmd). Det kan være, at eleverne selv har indsamlet data og ellers er der et væld af datasæt til eksempelvis binær klassifikation på [kaggle.com](https://www.kaggle.com/datasets?tags=14201-Binary+Classification).
