...
* Vælg $t$ som target-variabel og $x_1$ og $x_2$ som feature-variable.
...
Som opgave 3 viser, så afhænger tabsfunktionen $E$ af værdien af $p$, så vi kan se på funktionen $E(p)$, når vi alene kigger på, at $o=p$ for alle.
...
* Hvad kan du konkludere mht. sammenhængen mellem CA og E?
:::
