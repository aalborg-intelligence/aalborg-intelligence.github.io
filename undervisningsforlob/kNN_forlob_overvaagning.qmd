...
description: 'Nogle lande overvåger deres borgere. Men hvordan gør man mon det? I dette forløb bliver I ansat af efterretningstjenesten i landet Monitorbian for at hjælpe dem med at overvåge deres borgere.'
...
I Monitorbian findes der to forskellige slags indbyggere: Nogle nedstammer fra Anders And, mens andre nedstammer fra Fedtmule. På [@fig-indbyggere]{.nolink} kan du se, hvordan de forskellige indbyggere ser ud.
...
På [@fig-data]{.nolink} nedenfor ser I de træningsdata, som I selv angav en targetværdi for i den foregående opgave. Måske var det for nogle af indbyggerne svært at afgøre oprindelsen alene ved at se på billedet -- og måske var det nemt nok, men her ses i hvert tilfælde den korrekte klassificering[^2].
...
Beregn afstanden fra det grå punkt til de syv punkter, som er markeret i [@fig-data_afstande]{.nolink} herunder. Sørg for at skrive de beregnede afstande ned -- du skal bruge dem senere!
...
Vi ser nu igen på vores simple datasæt, og deler det op i et træningsdatasæt og et testdatasæt. På [@fig-data_test]{.nolink} er testdata markeret med et kryds. Vi vil for forskellige værdier af $k$ prædiktere farven på testdata (samtidig med at vi jo godt kender den faktiske værdi).
...
Der er flere ting, man kunne overveje at arbejde videre med. For eksempel kunne man sagtens forestille sig, at det kunne give mening med mere end to features. Afstandsformlen i (@eq-dist) kan faktisk sagtens udvides til flere dimensioner end to. Man finder eksempelvis afstanden mellem to punkter $(x_1,y_1,z_1)$ og $(x_2,y_2,z_2)$ i et tredimensionelt koordinatsystem på denne måde:
$$
