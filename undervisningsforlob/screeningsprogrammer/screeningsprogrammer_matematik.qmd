...
: Tabel med forholdet mellem syge og raske for de fem udvalgte genetiske markører. {#tbl-gen .bordered}
...
For syge ændrer vi middelværdien afhængig af det angivne forhold i [@tbl-gen]{.nolink} for den pågældende genmarkør, men beholder en spredning på $5$. Det ser sådan her ud:
...
- Brug [femfolds krydsvalidering](/noter/krydsvalidering/krydsvalidering.html#sec-krydsvalidering){target="_blank"} og [klassifikationsnøjagtigheden (CA)](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"} til at vurdere de netværk, som I har trænet. 

- Lav en [confusion matrix](/noter/vurdering_model/vurdering_model.qmd#confusion-matrix){target="_blank"}
 for alle de netværk, som I har trænet. 
