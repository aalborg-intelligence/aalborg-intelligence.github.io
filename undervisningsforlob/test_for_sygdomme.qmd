...
Ovenstående dækkes i noten [Sandsynlighedsregning og mængdeteori](../noter/sandsynlighed/sandsynlighed.qmd).
...
Dette forløb handler om at forstå forskellige sandsynligheder i forbindelse med test for sygdomme. Du skal blandt andet lære, hvad **sensitivitet**, **specificitet**, **prævalens** samt **positiv** og **negativ prædiktiv værdi** betyder. 
...
Når man tester for en sygdom, vil man måske umiddelbart tænke, at hvis testen er positiv, så er man syg, og hvis testen er negativ, så er man rask. Men det behøver faktisk ikke at være tilfældet. Man kan godt være rask, selvom testen er positiv (det kalder man for en falsk positiv), og man kan godt være syg, selvom testen er negativ (det kalder man for en falsk negativ). Det er fordi, at der ikke findes nogen test, som er helt perfekt! 
...
+ *Min test er positiv -- hvad er sandsynligheden for, at jeg rent faktisk er syg?*

eller

+ *Min test er negativ -- hvad er sandsynligheden for, at jeg rent faktisk er rask?*
...
Hvis du har læst afsnittet om [Betinget sandsynlighed og uafhængighed](../noter/sandsynlighed/sandsynlighed.qmd#betinget-sandsynlighed-og-uafhængighed) så ved du, at en betinget sandsynlighed er defineret på følgende måde:
...
\end{aligned}
$$
Det her er faktisk **Loven om total sandsynlighed**, som vi behandlede i afsnittet [Opdeling og sandsynlighed](../noter/sandsynlighed/sandsynlighed.qmd#opdeling-og-sandsynlighed).
...
Det skulle meget gerne stemme med det, du har fået i opgave 4 (men hvor den positive prædiktive værdi blev beregnet på baggrund af tabelværdier).
...
+ Brug nu formlen i (@eq-PPV_formel) til at beregne den positive prædiktive værdi ($P(\textrm{syg } | \textrm{ positiv test})$) for de fire forskellige prævalenser og udfyld denne tabel:
