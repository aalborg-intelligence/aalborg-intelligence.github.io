...
* Tæl antallet at helt hvide pixels på ovenstående to billeder.
...
* Indsæt et tomt punktplot (det er vigtigt at det er et **punkt**-plot og ikke et linjeplot).
* Højreklik på diagrammet og tryk på \"Vælg data...\".
* Tryk på \"Tilføj\"-ikonet.
* Ved \"Serienavn\" skriver du \"Tallet 0\"
* Under \"X-serieværdier\" markerer du de første 100 tal i søjlen med \"pixel_gns\" (`C2:C101`).
* Under \"Y-serieværdier\" markerer du de første 100 tal i søjlen med \"antal_tomme\" (`D2:D101`).
* Tilføj en serie i samme punktplot og giv den navnet \"Tallet 1\"
* Under \"X-serieværdier\" markerer du de sidste 100 tal i søjlen med \"pixel_gns\" (`C102:C201`).
* Under \"Y-serieværdier\" markerer du de sidste 100 tal i søjlen med \"antal_tomme\" (`D102:D201`).
