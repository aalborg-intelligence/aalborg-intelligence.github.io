...
$$ {#eq-tabsfunktion}
hvor der summeres over alle træningsdata. Husk, at $t$ kun kan antage værdierne $0$ og $1$, mens $o$ er et reelt tal mellem $0$ og $1$.


::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 2: Udregn værdien af tabsfunktionen i eksemplet
...
::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 3: Udregn E for andre værdier end $o=0.5$
