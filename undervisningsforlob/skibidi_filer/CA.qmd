...
Måske du i opgave 1 så på [klassifikationsnøjagtigheden (CA)](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"}[^CA]. Hvis ikke, så lav opgave 1 igen.

[^CA]: Klassifikationsnøjagtigheden er den andel af input, som modellen klassificerer korrekt. Så CA=0.85 betyder, at modellen rammer rigtigt for 85% de givne input og forkert for 15%. Her skal det bemærkes, at vi klassificerer ud fra, om $o>0.5$, hvor vi klassificerer som \"Ja\".
