...
description: 'Dette forløb handler -- udover at du skal være sengetester i IKEA -- om at give en forståelse for softmax-funktionen, som blandt andet bruges i simple neurale netværk til multipel klassifikation og i de store sprogmodeller.'
image: "sengetester/seng.jpg"
categories:
  - "03_C-niveau"
  - "04_Kort"
---
...
![](sengetester/seng.jpg){style='float:right;'  width=40%}

Efter at have sovet dejligt længe og tjent nogle gode penge, er resultatet følgende for 4 forskellige af IKEAs madrasser:
...
### Opgave 1: Udregn sandsynlighederne
* Udregn sandsynlighederne for hver af de 3 andre typer boxmadrasser.
* Læg sandsynlighederne sammen og se, at det giver 1.

:::

Det fungerer jo sådan set meget godt. Der er dog nogle grunde til, at man ofte gør det lidt mere kompliceret:
...
Man benytter derfor nogle gange metoden Softmax, hvor man opløfter tallet $\mathrm{e}$ i hvert pointtal, og derefter regner sandsynlighederne på samme måde som før.

Så bliver $$P(\mathrm{ Skotterud }) = \frac{\mathrm{e}^{3}}{\mathrm{e}^{3}+\mathrm{e}^2+\mathrm{e}^3+\mathrm{e}^{5}} \approx 10.2\%$$


::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 3: Udregn sandsynlighederne med Softmax
* Udregn sandsynlighederne for hver af de 3 andre typer boxmadrasser fra opgave 1 med Softmax metoden.
* Læg sandsynlighederne sammen og se, at det giver 1.

* Udregn på samme måde sandsynlighederne ud fra pointtallene fra opgave 2 med Softmax. 
* Læg sandsynlighederne sammen og se, at det giver 1.
