...
description: 'Dette forløb handler -- udover at du skal være sengetester i IKEA -- om at give en forståelse for softmax-funktionen, som blandt andet bruges i simple neurale netværk til mulipel klassifikation og i de store sprogmodeller.'
