...
FLOT FIGUR - 2X2 inputneuroner, to i det skjulte lag, og to i outputlaget.
...
$$\overrightarrow{v}_{\text{en}} = \begin{pmatrix} 1\\-2\end{pmatrix}, \qquad \overrightarrow{v}_{\text{kat}} = \begin{pmatrix} 3\\0 \end{pmatrix}$$
Vi vil bruge det neurale netværk til at beregne sandsynligheden for næste ord. 

- Beregn den 4-dimensionale vektor $\overrightarrow{x}$, der skal bruges som input til netværket, ved at sætte vektorerne $\overrightarrow{v}_{\text{en}}$ og $\overrightarrow{v}_{\text{kat}}$ oven på hinanden.
