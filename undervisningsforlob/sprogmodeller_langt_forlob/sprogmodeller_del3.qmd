...
Formålet med denne del er dels at gennemføre beregningerne i Word2Vec for et meget lille tekstkorpus, dels at forstå, hvad det vil sige at optimere vektorerne, så tabsfunktionen minimeres.


## Et meget lille tekstkorpus

Vi vil anvende følgende meget simple tekstkorpus med 12 sætninger, som kun anvender 5 forskellige ord:
...
I det første vindue er \"Hunden\" fokusord, mens \"sover\" er kontekstord. I det andet vindue er \"Hunden\" kontekstord, mens \"sover\" er fokusord. Vi ser altså bort fra punktummer, og vi forestiller os heller ikke, at teksten fortsætter på næste linje. Bemærk, at det er forsimplet i forhold til, hvordan det gøres i Word2Vec.

Helt overordnet er idéen så, at vi skal bestemme værdier til fokus- og kontekstvektorer for alle fem ord, så værdien af tabsfunktionen minimeres.
...
\end{aligned}
$$
Til disse værdier af vektorerne skal vi nu have beregnet værdien af tabsfunktionen $L$. Men lad os først visualisere vektorerne i en interaktiv figur, der både viser vektorerne og beregner værdien af tabsfunktionen:
...
:::
:::
Interaktiv figur til opgave 2.
:::

::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 2: Leg med den interaktive figur
 - Kontroller, at vektorerne i [@fig-opg2]{.nolink} passer til de værdier, vi valgte ovenfor.
 - Skriv ned, hvad værdien af tabsfunktionen er i udgangspunktet.
 - Ændr vektorerne, og bemærk at værdien af tabsfunktionen $L$ ændrer sig.
...
Som det næste skal sandsynlighederne for, at et ord er kontekstord til et andet, udregnes. For eksempel udregnes sandsynligheden for at \"sover\" er kontekst til \"hunden\" på denne måde:
...
- Kig grundigt på de 12 linjer i vores tekstkorpus, og overvej, hvilke sandsynligheder, der er relevante at udregne, fordi de optræder i teksten. Det er betydeligt færre end alle 25 kombinationer af de 5 ord, fordi mange af kombinationerne slet ikke optræder -- for eksempel indeholder tekstkorpus ikke kombinationen \"Hunden spinder\".
...
- Kontroller, at det stemmer med værdien fra den interaktive figur i @fig-opg2, inden du ændrede vektorerne.
...
Foretag lignende overvejelser for hvert fokusord, og forsøg så at placere både fokus- og kontekstvektorerne i den interaktive figur i @fig-opg2 ud fra disse overvejelser. For eksempel skal \"sover\" som kontekstvektor nok tættere på \"Katten\" end på \"Hunden\" som fokusvektorer, da \"Katten sover\" optræder oftere[^1] end \"Hunden sover\" i teksten. 

[^1]: Antallet af gange, en kombination optræder i tekstkorpus, har betydning for værdien af tabsfunktionen -- se (@eq-tabsfkt).

Med lidt held og yderligere justeringer i den interaktive figur, bør du kunne få værdien af tabsfunktionen så lav som mulig. 

::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 5: Optimering

- Minimer værdien af tabsfunktionen ved at ændre vektorerne i den interaktive figur i @fig-opg2.
- Beregn selv værdien af tabsfunktionen for de ændrede vektorer.
- Kontroller, at det stemmer med værdien i den interaktive figur.
- Hvis I er flere, kan I jo se, hvem der kan få værdien mindst mulig. Tættest på 22,85 vinder!
