---
title: "Del 4: Tekstgenerering med neurale netværk"
---
...
Læs afsnittet [Neuralt netværk i noten om tekstgenerering med neurale netværk](../../noter/sprogmodeller/tekstgenerering.qmd#neuralt-netværk) eller se videoerne her:
...
![](../../noter/sprogmodeller/images/NN_tekstgenerering.png){width=50% fig-align='center'}
...
## Aktivitet 2 - Beregning af sandsynligheder med neuralt netværk {.aimat}
...
Læs afsnittet [Træning af netværk](../../noter/sprogmodeller/tekstgenerering.qmd#træning-af-netværket) eller se videoen her:
...
Vi forestiller os, at vi har ordnet ordene i vores ordforråd på denne måde:
...
Vi har trænet to netværk, som for dette træningseksempel har givet følgende outputvektor (på alle andre koordinater i vektoren står der værdier meget tæt på $0$)
...
* Vis, at alle koordinaterne i $\vec z$ kan fortolkes som sandsynligheder, og at summen af sandsynlighederne er 1.
...
## Aktivitet 4 -  Tekstgenerering {.aimat}

Læs afsnittet [Tekstgenerering](../../noter/sprogmodeller/tekstgenerering.qmd#tekstgenerering). 
...
- Hvis der allerede står \" En hund \", hvor mange forskellige muligheder er der så for det næste ord (tæl bare hvor mange forskellige ord, der er i tekstkorpus)?

Antag, at vi har trænet et netværk, der giver
$$
\begin{align}
&P(\text{hund } |\text{ "en hund" }) = 0.01 \\
&P(\text{kat } |\text{ "en hund" }) = 0.03 \\
&P(\text{en } |\text{ "en hund" }) = 0.17 \\
&P(\text{efter } |\text{ "en hund" }) = 0.27
\end{align}
$$
...
### Opgave 5: Antal kombinationer

Antag, at et netværk er trænet på et lille tekstkorpus, som det vi har set ovenfor, og at vi har fået de fem sandsynligheder, som står i opgave 4.
...
### Opgave 6: Mest og mindst sandsynlige næste ord

Vi vil bruge denne [Excel-fil](transformer_trænede_sandsynligheder.xlsx) med sandsynligheder til at prædiktere nye ord i en sætning.

Vi starter med \"En hund\" som de to første ord.

- Hvad er det mest sandsynlige tredje ord? Vælg det ord.

- Hvad er nu det mest sandsynlige fjerde ord? Vælg det ord.

- Hvad er nu det mest sandsynlige femte ord? Vælg det ord.

Du har formentlig fået en sætning, som giver nogenlunde mening. Lad os se på, hvad der sker, hvis vi hele tiden vælger det mindst sandsynlige næste ord! Start igen med \"En hund\" som de to første ord.

- Hvad er det mindst sandsynlige tredje ord? Vælg det ord.

- Hvad er nu det mindst sandsynlige fjerde ord? Vælg det ord.

- Hvad er nu det mindst sandsynlige femte ord? Vælg det ord.

Du har nok fået en sætning nu, som giver meget lidt mening!
...
[Næste $\rightarrow$](sprogmodeller_del5.qmd){.next}
