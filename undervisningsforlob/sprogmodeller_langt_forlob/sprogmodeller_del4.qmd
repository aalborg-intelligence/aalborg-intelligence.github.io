...
4. Outputtet fra hvert opmærksomhedslag er en $64$-dimensional vektor.  Outputtet fra de $12$ opmærksomhedslag sættes i forlængelse af hinanden til en vektor $\overrightarrow{x}_i$. Hvilken dimension har $\overrightarrow{x}_i$? 

5. Som det næste bliver $\overrightarrow{x}_i$ brugt som input i et neuralt netværk. GPT-2 bruger $d=4\cdot 768$ neuroner i det skjulte lag og outputtet er en ny vektor af dimension $768$. Hvor mange vægte skal der i alt bruges til det neurale netværk (brug eventuelt din beregning fra Opgave 1 i del 3 LINK).
