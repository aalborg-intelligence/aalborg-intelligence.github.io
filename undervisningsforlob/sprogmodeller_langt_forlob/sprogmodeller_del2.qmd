...
For at finde minimum for tabsfunktionen har man brug for at bestemme såkaldte *partielle afledede*. Hvis du ikke har hørt om det før, så kan du læse mere i boksen herunder.
...
For at diffentiere denne funktion, får vi brug for kvotientreglen for differentiation:
...
a) Vis følgende egenskaber ved de partielle afledte af Softmax-funktionen:
...
Bemærk, at ovenståend opgaver giver, at man ikke behøver at kende værdien af $\vec{y}$ i det punkt, hvor man differentierer, men kun funktionsværdien $\vec{z}$. Det viser sig at have meget store beregningsmæssige fordele, når man skal finde minimum for tabsfunktionen, så det er faktisk en overordentlig vigtig egenskab!
