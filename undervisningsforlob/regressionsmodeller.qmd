...
image: "regressionsmodeller_filer/cement.jpg"
categories:
  - "01_A-niveau"
  - "04_Kort"
---
...
### Opgave 1
 ...
 - Lav lineær regression på [træningsdatasættet](/undervisningsforlob/regressionsmodeller_filer/concrete_train.xlsx) med cement som forklarende variabel:
...
* Brug [app'en](https://apps01.math.aau.dk/ai/nn-regression/){target="_blank"} til at lave et kunstigt neuralt netværk med to skjulte lag med hver 10 neuroner. Vælg en learning rate på $0.00001$, $5000$ iterationer og ReLu som aktiveringsfunktion. Træn netværket på træningsdata og test det på testdata. 
