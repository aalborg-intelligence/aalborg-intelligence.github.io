...
Brug den interaktive figur nedenfor.
...
I den interaktive figur herunder er $27$ andre punkter indsat i et koordinatsystem, og der er tegnet en cirkel med centrum i det grå punkt $P(15,15)$. Ændr på radius af cirklen og se, om det gør en forskel.
...
Her er et eksempel fra kommunalvalget i 2025.

[Tag kandidattesten Kommunalvalg 2025 - Altinget - Alt om politik:
altinget.dk](https://www.altinget.dk/kandidattest)

::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 14

Klik på linket ovenfor, vælg din egen kommune i testen og besvar spørgsmålene. Se derefter, hvem dine svar er mest enige med, og hvor mange procent enige I er. Klik også på "Sammenlign svar", hvor du i detaljer kan se, hvor I er enig eller uenige
...
[Facitliste](hvem_ligner_du_mest_filer/hvem_ligner_du_facit.qmd){target="_blank"}.