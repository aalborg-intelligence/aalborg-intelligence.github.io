...
Her kaldes $t$ for **target**, fordi det er den værdi, vi gerne vil prøve at \"ramme\" med vores model.
...
Nu har vi $300$ personer i vores træningsdata. For hver af dem kan vi beregne en kvadreret forskel mellem $t$ og $o$ og så lægger vi dem alle sammen og ganger med $1/2$ (det sidste er ikke så afgørende). Det giver:
...
Du kan [her](../../noter/logistisk/log-reg.qmd#fortolkning-af-parametrene-i-den-logistiske-regressionsmodel){target="_blank"} dykke dybere ned i, hvordan man kan give en mere konkret fortolkning af vægtene.
