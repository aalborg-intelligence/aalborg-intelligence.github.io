...
Når du har lavet opgave 2, kan du kontrollere dit resultat [her](facit_informatik_opgave2.qmd){target="_blank"}.
...
* Lav en app i [App Lab](code.org). På forsiden skal der være tre knapper, som leder hen til tre forskellige sider, hvor man kan:
...
*	Lav en tabel, som hedder \"OCEAN\", og som har kolonnerne \"spg\", \"kat\" og \"type\" ligesom tabellen i videoen. Indsæt de fem spørgsmål, som hører til \"Neuroticism\".

![](images/screen_ocean.png){style='float:right; margin-left:1rem; border:1px solid black' width="30%"}

*	Lav en skærm som den i videoen, hvor der er en label (med id \"label_spg\") med plads til spørgsmålet og de fem radio buttons $\longrightarrow$

*	Ret din kode til (så id'erne passerne med koden) og tjek, at du kan få vist de fire spørgsmål på skærmen.
...
stammer fra [geeksforgeeks]( https://www.geeksforgeeks.org/javascript-program-for-normal-cdf-calculator) (\"Approach 2: Using Taylor Series Expansion\") og kan bruges til at beregne

$$
P(Z \leq z)
$$

når $Z$ er standard normalfordelt.
