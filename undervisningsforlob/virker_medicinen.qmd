...
+ Planens ligning i rummet på formen $ax+by+cz+d=0$.
...
t = 
\begin{cases}
1 & \textrm{hvis medicienen har effekt} \\
-1 & \textrm{hvis medicienen ikke har effekt}
\end{cases}
$$
...
Nedenstående datasæt er brugt til at lave @fig-3D herunder.
...
Nedenstående datasæt er brugt til at lave @fig-kurve herunder.
