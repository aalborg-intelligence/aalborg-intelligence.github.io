...
description: 'Hvordan afgør man, om to tekster eller to DNA-strenge er \"tæt\" på hinanden? Det er fokus i dette korte forløb.' 
...
- Udregn med den metode afstanden mellem \"nedes\" og hver af de $3$ ord i opgave 1. Var det sådan du allerede havde gjort det i opgave 1, eller gav dette et andet resultat?
...
Uden i øvrigt at komme ind på biologien repræsenteres DNA som meget lange tekststrenge. Når mennesker og chimpanser er meget ens, kommer det til udtryk ved, at DNA-strengen for et menneske ligner DNA-strengen for en chimpanse meget. Der er altså en kort afstand mellem DNA'et hos et menneske og hos en chimpanse.. Inden for biologien kaldes dette alignment. I stedet for at sammenligne på DNA niveau, sammenlignes også nogle gange på aminosyre niveau, hvilket vi vil bruge her.
...
Når resultatet sikkert virker overraskende, skyldes det, at vi kun har set på et meget lille udsnit af DNA for de fire. I [@fig-DNAafstand]{.nolink} har man set på hele det protein, som udsnittet stammer fra, og her bliver resultatet mere som forventet.
