...
Du kan også læse meget mere om [perceptroner her](../noter/perceptron/perceptron.qmd).
...
g(x)=x^2-2x-3
$$
Her er koefficienterne $a=1, b=-2$ og $c=-3$. Men $g$ har præcis samme rødder som $f$ -- nemlig $-1$ og $3$. Dette ses også illustreret i [@fig-samme-roedder]{.nolink}, hvor grafen for $f$ og $g$ begge skærer $x$-aksen i $-1$ og $3$.
