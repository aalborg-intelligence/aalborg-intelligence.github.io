...
description: 'Du kender det sikkert godt. Du har lige set en serie på Netflix, og så anbefaler Netflix dig en ny serie, som viser sig at være spot-on! Men hvordan kan det lade sig gøre? Det kan du lære meget mere om her.'
image: "../noter/anbefalinger/images/film.jpg"
categories:
  - "01_A-niveau"
  - "04_Kort"
---
...
Formålet med dette forløb er at få en forståelse for, hvordan streamingtjenester og sociale medier kan lave individualiserede anbefalinger til deres brugere. Herunder hvordan samarbejds- og indholdsbaserede algoritmer virker.

:::

## Anbefalet til dig

Læs indledningen i [noten Anbefalet til dig](../noter/anbefalinger/anbefalinger.qmd) *indtil* afsnittet \"En samarbejdsbaseret algoritme\".

![](../noter/anbefalinger/images/film.jpg){fig-align='center' width=50%}
...
Læs hele afsnittet [En samarbejdsbaseret algoritme](../noter/anbefalinger/anbefalinger.qmd#en-samarbejdsbaseret-algoritme).

::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 2: Online elektronikbutik

En online elektronikbutik har 1.000.000 kunder. Heraf har 235.476 købt
en computer, 423.517 har købt en mus og 114.237 har købt et tastatur, 23.127
har købt både computer og mus, mens 51.633 har købt både computer og
tastatur.

-   Beregn frekvensen af $H_{\{\text{computer}\}}$,
    $H_{\{\text{mus}\}}$, $H_{\{\text{tastatur}\}}$,
    $H_{\{\text{computer,mus}\}}$ og
    $H_{\{\text{computer, tastatur}\}}$. Hvilken vare var mest populær?

-   Beregn $\hat{P}( H_{\{\text{mus}\}} \mid H_{\{\text{computer}\}})$ og
    $\hat{P}(H_{\{\text{tastatur}\}} \mid H_{\{\text{computer}\}} )$. Hvilken
...
Se på datasættet i [@tbl-data]{.nolink} herunder.

-   Beregn frekvenserne af $H_{\{\text{Blinkende Lygter}\}}$,
    $H_{\{\text{Olsen-banden}\}}$ og
    $H_{\{\text{Blinkende Lygter, Olsen-banden}\}}$.

-   Beregn
    $\hat{P}(H_{\{\text{Olsen-banden}\}}\mid H_{\{\text{Blinkende lygter}\}} )$
    og $\hat{P}( H_{\{\text{Hævnen}\}}\mid H_{\{\text{Blinkende lygter}\}})$.
...
I afsnittet [En indholdsbaseret algoritme](../noter/anbefalinger/anbefalinger.qmd#en-indholdsbaseret-algoritme) skal du starte med at læse underafsnittet [Multipel lineær regression](../noter/anbefalinger/anbefalinger.qmd#multipel-lineær-regression) og [Flere variable](../noter/anbefalinger/anbefalinger.qmd#flere-variable).
...
-   En bruger, som foretrækker gamle film, men hader lange film, har
    vægtene $a_1=-0.01$, $a_2=-0.1$ og $a_3= 0.1$ samt $b=2.8$.
...
-   En anden bruger foretrækker film af god kvalitet, men går ikke op i
    varighed og alder. Vedkommende har derfor præferencerne $b=-4$,
    $a_1=0$, $a_2=0$, $a_3=1$. Prædiktér brugerens ratings og anbefal
    en film.
::::
...
Den multiple regressionsmodel med $k$ variable $x_1,\ldots,x_k$ har formen  
$$ \hat{r}=b + a_1x_1 + a_2x_2 + \dotsm + a_kx_k $$ 
...
Læs afsnittet [Estimation af vægte](../noter/anbefalinger/anbefalinger.qmd#estimation-af-vægte). 

::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 7: Udregning af tabsfunktion
...
- Betragt vægtene $b=3.8$, $a_1=-0.02$, $a_2=-0.05$ og $a_3=0.3$. Beregn værdien af tabsfunktionen ved at følge nedenstående trin:
  - Beregn de prædikterede ratings for hver af de tre film ved hjælp af formlen
  $$ \hat{r}=b + a_1x_1 + a_2x_2 + a_3x_3 $$ 
...
For at finde de vægte, der minimerer tabsfunktionen, får man brug for at finde de partielle afledede af tabsfunktionen. Hvis du ikke ved, hvad partielle afledede er, kan du med fordel starte med at se videoen [Funktioner af to variable 1: Introduktion og partielle afledede](https://youtu.be/tlq2UYWF2Rw?si=yWpim12TCpuv1YLG){target="blank"}.

I noten påstås det blandt andet, at
...
Læs afsnittet [Mere fleksible modeller](../noter/anbefalinger/anbefalinger.qmd#mere-fleksible-modeller).

## Samarbejdsbaserede modeller for ratings

I afsnittet [Samarbejdsbaserede modeller for ratings](../noter/anbefalinger/anbefalinger.qmd#samarbejdsbaserede-modeller-for-ratings) skal du læse introduktionen og afsnittet [Matrixfaktorisering](../noter/anbefalinger/anbefalinger.qmd#matrixfaktorisering) og [Skæring i modellen](../noter/anbefalinger/anbefalinger.qmd#skæring-i-modellen).
...
::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 9: Antal vægte som skal estimeres
...
Læs afsnittet [Estimation af vægte](../noter/anbefalinger/anbefalinger.qmd#estimation-af-vægte-1).

:::::: {.callout-note collapse="false" appearance="minimal"}
### Opgave 10: Ratings

Tre brugere har ratet tre film, som følger:
...
Vi betragter en model med to features på formen (hvor $\hat{r}_{ij}$ er den $i$te brugers prædikterede rating af $j$te film):

$$
\hat{r}_{ij} = a_{i1}x_{1j} + a_{i2}x_{2j} 
$${#eq-matrixfak}


Vi forestiller os, at vi har valgt, hvad vægtene i modellen skal være. De tre film har featurevægtene:
...
[Facitliste](anbefalingssystemer/anbefalingssystemer_facit.qmd){target="_blank"}.
