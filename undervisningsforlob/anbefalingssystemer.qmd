...
-   En anden bruger foretrækker film af god kvalitet, men går ikke op i
    ...
    $p_1=0$, $p_2=0$, $p_3=1$. Prædiktér brugerens ratings og anbefal
    en film.
::::
...
- Betragt vægtene $b=3.8$, $p_1=-0.02$, $p_2=-0.05$ og $p_3=0.3$. Beregn værdien af tabsfunktionen ved at følge nedenstående trin:
  - Beregn de prædikterede ratings for hver af de tre film ved hjælp af formlen
  $$ \hat{r}=b + p_1x_1 + p_2x_2 + p_3x_3 $$ 
...
- Gentag udregningen med vægtene $b=1.8$, $p_1=0.01$, $p_2=-0.1$ og $p_3=0$.
...
$$
\hat{r}_{ij} = p_{i1}x_{1j} + p_{i2}x_{2j} 
$${#eq-matrixfak}
