...
* Posteriorforholdet 
   ...
   Når man bruger Bayes formel til at udlede ovenstående, forkortes $P(X_1=x_1, X_2=x_2, X_3=x_3)$ væk.
   
* Hvis posteriorforholdet er større end $1$:
  $$
  ...
  \end{aligned}
  $$
  Det vil sige, at hvis posteriorforholdet er større end $1$, så vil der være størst chance for, at der er tale om en spam mail.
...
Faktorer der taler for spam (positiv vægt):
...
Faktorer der taler for ham (negativ vægt):
