...
Alle pilene i [@fig-neuralt_net]{.nolink} kaldes for vægte. I netværket her, er der overordnet set $v$-, $u$- og $w$-vægte.
...
Ved hjælp af inputvariablene og $v$-vægtene (de lysegrønne pile på [@fig-neuralt_net]{.nolink}) beregner vi $z_1$:
...
På tilsvarende vis udregner vi $z_2$ ved at bruge $u$-vægtene (de mørkegrønne pile på [@fig-neuralt_net]{.nolink}):
...
Når vi nu har $z_1$ og $z_2$ kan outputværdien $o$ for eksempel beregnes på denne måde (her er $w$-vægtene vist som de lyseblå pile på [@fig-neuralt_net]{.nolink}):
...
Betragt følgende netværk, hvor det skjulte lag kun består af én neuron:
...
$$
hvor vi har sagt, at $x$ bare er en lineær kombinationen af de to features: $x=v_1 \cdot x_1 + v_2 \cdot x_2$. Så er outputværdien $o$:
