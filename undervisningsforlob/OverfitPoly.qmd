...
I dette eksempel vil vi se på populationen \"danske gymnasieelever\", hvor vi -- indrømmet fjollet -- vil undersøge, om der er en sammenhæng mellem den uafhængige variabel \"antal biografbesøg det seneste år\" og den afhængige variabel \"antal venner på de sociale medier\". Vi lader som om, vi har indsamlet en stikprøve med 8 gymnasieelever med følgende resultat:
...
Vi ønsker ud fra disse data at opstille en model, som for nye observationer kan forudsige, hvor mange venner på de sociale medier en gymnasieelev har, hvis man kender antallet af biografbesøg.
...
Svaret på opgave 2 bør ikke være overraskende. Jo højere grad af polynomium, desto bedre kan grafen tilpasse sig punkterne. Når graden er antallet af punkter minus 1, altså her graden 7, passer grafen perfekt til alle punkterne. Men betyder det så også, at det fundne 7. gradspolynomium passer godt til fremtidige observationer og dermed til at prædiktere, hvor mange venner på de sociale medier andre elever har ud fra antal biografbesøg? Det vil vi undersøge nærmere i resten af forløbet.
...
Her er vist et eksempel i GeoGebra. I eksemplet laves 3. gradsregression, hvor punkterne 3 og 4 er fjernet. Desuden er den lodrette afstand fra hver af de to fjernede punkter til grafen vist. 
...
![3. gradsregression og residualer i Maple](OverfitPoly_filer/3gradsregression6af8.png){#fig-3gradsMaple}
...
*	Lav 3. gradsregression ud fra 6 af punkterne, idet I ikke medtager de to første punkter.
...
*	Beregn den lodrette afstand mellem grafen og hver af de 2 punkter, som ikke var med i regressionen. Disse kaldes for residualer, så lad os kalde dem for $r_1$ og $r_2$. Skriv værdierne i en tabel som den nedenfor. Residualerne regnes med fortegn, så hvis punktet ligger under grafen, er residualet negativt.
...
*	Gentag regression og beregninger for samme grad, hvor det nu er de to næste punkter, der ikke er med i regressionen, så de to næste og endeligt de to sidste.
...
Hvis du og din gruppe er hurtigere færdige end de andre, så læs mere om [krydsvalidering i denne note](../noter/krydsvalidering/krydsvalidering.qmd).
