...
I dette forløb vil vi se på, hvordan algoritmen K-means kan anvendes til at inddele musiknumre i grupper, f.eks. for at en musiktjeneste kan give anbefalinger til ny ny musik, som man sikkert gerne vil høre.
:::
...
* Læs [noten Clustering med K-means](../materialer/k-means/k-means.qmd) ... *til og med* afsnittet \"Eksempel på algoritmen\".
...
Her ses på et mindre eksempel med 15 musiknumre man ønsker at opdele i 3 grupper ud fra 3 features : danceabilty, energy og speechiness.Numrene er placeret i tilfældige gruppe fra start i forhold til algoritmen.
...
Nu skal vi igang med at finde afstanden fra hvert nummer til hvert centrum. Her skal du selvfølgelig bruge resultatet fra forrige opgave, hvor du fandt de tre centre.
...
Herunder er alle afstande til de tre centre beregnet for alle numre. Desuden er der angivet en ny gruppe for \"Barbie girl\", da det nummer ligger tættest på centrum for gruppe 1.
 ...
 * Bestem ny gruppe for alle numrene.
 * forklar hvorfor vi ikke er færdige med at opdele i de 3 ønskede grupper med kmeans metoden. 
:::
