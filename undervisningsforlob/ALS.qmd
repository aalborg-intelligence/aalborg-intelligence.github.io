...
Vi forestiller os, at der optages hjernesignaler fra en person, der tænker på en bevægelse med foden, når han/hun ønsker at vælge et bestemt punkt i en menu. Til alle andre tidspunkter sidder personen og slapper af, og derfor optages kun den almindelige baggrundshjerneaktivitet. Der er altså her tale om et binært kontrolsignal[^1]: enten tænker personen på at bevæge foden, eller også tænker han/hun *ikke* på at bevæge foden. 
...
2) Magnus skal ikke bruge nogle af bogstaverne i denne del af menuen, så han slapper bare af i de 2 sekunder. Det fortolker vi, som at Magnus har sagt \"nej\" til bogstaverne i den første kategori og går derfor frem i menuen og viser Magnus denne del:
...
* Find på andre eksempler på teknologi/applikationer man kan styre med hjernen ved at have et binært kontrolsignal, som for eksempel kobles sammen med en menu. Det behøver ikke
...
Hent Excel-filen med data, gem den på egen computer og gør følgende for de data, som ligger i fanen \"Data til træning\":

* Lav punktplot af data for følgende imaginære bevægelser: 1, 5, 10 og 15 (det vil sige 4 figurer i alt). 
...
* Lav på tilsvarende vis punktplot for følgende gentagelser af baggrundshjerneaktivitet: 1, 5, 10 og 15 (det vil sige 4 figurer i alt).
  
* Kan du umiddelbart ud fra de 8 punktplot se, om der er noget, som adskiller de imaginære bevægelser fra baggrundshjerneaktiviteterne?
...
* Lav et punktplot for de beregnede gennemsnit fra de imaginære bevægelser i træningsdata.

* Udregn og lav punktplot på tilsvarende vis for gennemsnittet på tværs af de 15 måleserier af baggrundshjerneaktivitet i træningsdata.

* Kan du på de to punktplot af gennemsnittene se, om der er noget, som adskiller de imaginære bevægelser fra baggrundshjerneaktiviteterne? Beskriv mundtligt så præcist som muligt, hvad det er, der adskiller de to punktplot.
...
Inddel data i tre (næsten) lige store dele og udregn et gennemsnit af målingerne i hver del:
...
<summary> Sådan gør du i Excel </summary>
  ...
  * I celle `B1004` skriver du: `=MIDDEL(B3:B335)-MIDDEL(B336:B668)`
  * I celle `B1005` skriver du: `=MIDDEL(B336:B668)-MIDDEL(B669:B1002)`
...
* Lav et punktplot med \"Feature 1\" ud af $x$-aksen og \"Feature 2\" op ad $y$-aksen for de 15 måleserier, som stammer fra baggrundshjerneaktiviteter.

<details>
<summary> Sådan gør du i Excel </summary>

* Indsæt et tomt punktplot, som du gjorde i opgave 2.
...
* Vil du i dit punktplot kunne indtegne en linje, som adskiller de to forskellige typer af punkter fra hinanden? 
...
* Gør som i opgave 6, men lav nu punktplot med features fra *testdatasættet*. Brug de samme farver som før, men lad punkterne være udfyldte, så du kan kende forskel på testdata og træningsdata.
...
Tæl nu, hvor mange punkter af hver type, der ligger på den rigtige side af linjen, og hvor mange, der ligger på den forkerte side. Vi bruger dermed linjen til at *klassificere* punktet som enten imaginær besvægelse eller baggrundsaktivitet, og sammenligner med den faktiske type af punktet.
