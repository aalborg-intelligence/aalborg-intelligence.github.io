...
Hvis du vil vide mere, kan du læse i noten om [overfitting, modeludvælgelse og krydsvalidering](../../noter/krydsvalidering/krydsvalidering.qmd).
...
- Træn en kunstig neuron med de samme indstillinger, som du havde i opgave 3 i [del 4](kunstige_neuroner_del4.qmd), men sæt startvægtene til $0$ og sæt antal iterationer til $10000$. Tryk på \"Træn model\".

- Under fanen \"Evaluering & Prædiktion\" vælger du først \"Evaluering på træningsdata\". Tryk på \"Kør evaluering\" og noter [klassifikationsnøjagtigheden (CA)](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"}.

- Under fanen \"Evaluering & Prædiktion\" vælger du dernæst \"Evaluering via krydsvalidering\" og beholder antal fold på $5$. Tryk på \"Kør evaluering\" (det tager lige lidt tid).

- Sammenlign klassifikationsnøjagtigheden (CA) baseret på træningsdatasættet med CA baseret på krydsvalidering. Du vil nok opdage, at CA er lavere ved krydsvalideringen end ved at træne på hele datasættet -- forklar hvorfor det er tilfældet.
...
- Brug [neuron app'en](https://apps01.math.aau.dk/ai/neuron){target="blank"} med samme indstillinger som i opgave 2. Du fjerner variable under fanen \"Variable\", træner modellen igen under fanen \"Træning\" og laver $5$-folds krydsvalidering under fanen \"Evaluering & Prædiktion\".

- Udfyld nedenstående tabel. 

   *Forklaring: Med __CA (på træningsdata)__ menes den værdi for klassifikationsnøjagtigheden, som man får, når man bruger samme datasæt til både at træne og teste på (denne værdi kan ses under fanen \"Evaluering & Prædiktion\"). Med __CA1-CA5__ menes de værdier af klassifikationsnøjagtigheden (baseret på krydsvalidering), som man får, når man kører krydsvalidering fem forskellige gange uden at ændre på indstillingerne (kan igen beregnes under fanen \"Evaluering & Prædiktion\").* 
...
- Brug [neuron app'en](https://apps01.math.aau.dk/ai/neuron){target="blank"}, hvor startvægtene er sat til $0$ og antal iterationer til $10000$. Under fanen \"Evaluering og prædiktion\" vælger du \"Evaluering via krydsvalidering\" og trykker på \"Kør evaluering\" fem gange. Nedskriv de fem værdier for klassifikationsnøjagtigheden baseret på $5$-folds krydsvalidering.
