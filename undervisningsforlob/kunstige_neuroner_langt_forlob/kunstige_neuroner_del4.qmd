...
De træningsdata i [@tbl-goodfood]{.nolink}, som vi har brugt i de foregående aktiviteter, er i virkeligheden alt, alt for simple. 
...
#path = here::here("undervisningsforlob", "kunstige_neuroner_langt_forloeb", #"data", "goodfood.xlsx")
#)
# summary(dat)
...
Vi starter med at undersøge, om det ser ud som om, at vi har fundet et minimum for tabsfunktionen. En graf for tabsfunktionen som funktion af antal opdateringer af vægtene ses til højre i app'en, efter at du har trykket på \"Træn model\".
...
På baggrund af de to plots i opgave 5 skal vi have lavet en såkaldt [confusion matrix](/noter/vurdering_model/vurdering_model.qmd#confusion-matrix){target="_blank"} og derefter beregne en [klassifikationsnøjagtighed](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"}.
...
- Tryk på \"Træn model\". Ser det ud som om, at vi har fundet et minimum? Notér slutværdien af tabsfunktionen.
...
[Facitliste](kunstig_neuron_del4_facit.qmd){target="_blank"}.

{{< include ../space.qmd >}}

[$\leftarrow$ Forrige](kunstige_neuroner_del3.qmd){.prev}
[Næste $\rightarrow$](kunstige_neuroner_del5.qmd){.next}
