...
Når minimum for tabsfunktionen skal bestemmes bruges gradientnedstigning, som vi behandlede i [del 2](kunstige_neuroner_del2.qmd). Vi vil her opskrive opdateringsreglerne for $w_0$ og $w_1$, men i det helt simple tilfælde, hvor vi kun ser på ét træningseksempel ad gangen. 
...
Hvis værdierne slet ikke ændrer sig, skyldes det nok, at gradienthældningerne er så små, at GeoGebra får dem afrundet til 0, så der ingen ændring bliver. Reelt burde der nok ske en meget lille ændring, måske ud på det 30. decimal eller længere ude.
