...
Hvis værdierne slet ikke ændrer sig, skyldes det nok, at gradienthældningerne er så små, at GeoGebra får dem afrundet til 0, så der ingen ændring bliver. Reelt burde der nok ske en meget lille ændring, måske ud på det 30. decimal eller længere ude. Hvis det sker, så prøv at starte i $w_0 = -10$ og $w_1 = 0.8$.
...
Hvis du igen bliver fanget på det grønne plateau, så prøv med $w_0=30$ og $w_1=0.4$.  
