...
description: "Vi vil undersøge, hvordan AI kan genkende personer ud fra ganske få sekunders lydklip."
...
Forløbet indeholder ikke som sådan noget matematik, men giver en god start på begreber og metoder inden for kunstige neurale netværk. Matematikken bag kommer så i senere forløb.
...
I et kunstigt neuralt netværk er modellen betydeligt mere kompliceret, og der er mange flere vægte end de to i lineær regression (i store netværk kan der være milliarder af vægte), men idéen er den samme. Man skal også i kunstige neurale netværk bestemme vægtene i modellen, så den samlet set bedst muligt rammer targetværdierne ud fra featureværdierne.

I lineær regression skal modellen komme så tæt på targetværdien $y$ for hver featureværdi $x$. I vores tilfælde er det anderledes, da vi ikke skal tæt på en talværdi, men i stedet skal vælge mellem de fire personer -- dette kaldes for **klassifikation**. I lineær regression handler det således om, at linjen (modellen) kommer tæt på punkterne, mens det i klassifikation handler om, at modellen skal forudsige den rigtige oplæser for så mange som muligt af de små lydklip. Man taler derfor om [klassifikationsnøjagtigheden (CA)](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"}, som er andelen af korrekte forudsigelser. Så hvis $CA=0.85$, har modellen korrekt forudsagt $85\%$ af targetværdierne. Dermed er der altså $15\%$ forkerte forudsigelser.

Når man træner et kunstigt neuralt netværk, vælger man de vægte i modellen, der giver den højeste klassifikationsnøjagtighed på vores træningsdata.
...
* Klik på \"Confusion matrix\" i Orange for at se, hvilke input, der er klassificeret korrekt, og hvilke der er klassificeret forkert. 
...
* Find det misklassificerede klip og lyt til det. Er der noget ved klippet som gør det særligt svært at klassificere korrekt?
...
* Hør lydklippene for de misklassificerede. Er der noget særligt ved dem, som gør det sværere at klassificere?
...
Alle behøver ikke at lave denne del, som er temmelig teknisk. Det er nok, at én person gør det, og derefter deler filerne med alle. [Denne video viser, hvordan man gør](https://youtu.be/XZkxnXnfm_U?si=77trJ6UiF6dOQpAW){target="_blank"}, og ellers er det også beskrevet her:
...
* Lyt til de lydklip, som modellen misklassificerer. Kan du let høre, hvem der faktisk er?
...
* Er der stadig lydklip, som misklassificeres i den af dine modeller, som har bedst klassifikationsnøjagtighed (CA)? Lyt i så fald til disse lydklip. Kan du let høre, hvem det faktisk er?
