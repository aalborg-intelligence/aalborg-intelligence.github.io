...
Formålet med forløbet er, at I lærer lidt om, hvad kunstige neurale netværk er, og hvordan man ved hjælp af programmet \"Orange\" kan bruge sådan nogle netværk til at opklare en mordgåde. 
...
Alle fingeraftryk, som er fundet i lokalerne, er nummereret fra 101-110. Fingeraftrykkene er fundet i følgende lokaler:
...
*Vi skal gøre opmærksom på, at det, vi gør her, ikke er, sådan politiet arbejder med fingeraftryk. Dette er blot for at vise, hvordan man kunne bruge kunstig intelligens. *
...
+ Ved hjælp af [træningsdata](opklar_et_mord_filer/Træningsdata.zip) skal I træne forskellige neurale netværk, som kan prædiktere, hvem et givent fingeraftryk tilhører. Prøv med forskellige neurale netværk af forskellig dybde (det vil sige et varierende antal skjulte lag) og forskelligt antal neuroner i hvert skjult lag.

+ Sammenlign jeres forskellige modeller ved hjælp af \"Test and Score\" (brug [krydsvalidering](/noter/krydsvalidering/krydsvalidering.html#sec-krydsvalidering){target="_blank"})
 -- og husk at [klassifikationsnøjagtigheden (CA)](/noter/vurdering_model/vurdering_model.qmd#klassifikationsnøjagtighed){target="_blank"} skal være tæt på 1. \"Test and Score\" skal som input have billederne fra træningsdata og de forskellige modeller (det vil sige de forskellige neurale netværk).
