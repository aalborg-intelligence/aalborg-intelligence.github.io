...
Som du sikkert indså, er cross-entropy klart det bedste valg som tabsfunktion, når der skal ske klassifikation. Vi startede blot med squared-error, fordi dem er noget lettere at forstå. 
...
[$\leftarrow$ Forrige](neurale_net_del5.qmd){.prev}
[Næste $\rightarrow$](neurale_net_eksamen.qmd){.next}
