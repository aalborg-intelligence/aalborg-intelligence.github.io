...
- Brug de partielle afledede til at opskrive opdateringsreglerne:
   ...
   \end{aligned}
   $$
- Lav en beregning vha. disse opdateringsregler, idet der kun opdateres for den ældre person med $x=60$ og $t=1$. Brug værdierne  $\eta=0.1$, $w_0=-1$, $w_1=0.1$, og $o=0.9933$ og beregn nye værdier af vægtene. 

Med disse værdier skal du få $w_0^{\mathrm{(ny)}} = -0.9999955411$ og $w_1^{\mathrm{(ny)}} = 0.1002675354$, så vægtene er blevet ændret lidt ved opdateringen. 
...
Hvis værdierne slet ikke ændrer sig, skyldes det nok, at gradienthældningerne er så små, at GeoGebra får dem afrundet til 0, så der ingen ændring bliver. Reelt burde der nok ske en meget lille ændring, måske ud på de 30. decimal eller længere ude.
...
[$\leftarrow$ Forrige](neurale_net_del2.qmd){.prev}
[Næste $\rightarrow$](neurale_net_del4.qmd){.next}
