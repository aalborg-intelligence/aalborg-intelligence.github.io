...
- Lav et tilsvarende plot for mændene. Det kan f.eks. gøres ved at gemme dokumentet for kvinder og kopiere data for mændene fra Excel arket ind i regnearket i GeoGebra. Lav også en linje på mændene plots, som bedst muligt adskiller røde fra blå.

Behold de to GeoGebra dokumenter med plot og linje for hvert køn. Du skal bruge dem senere, når du skal sammenligne din opdeling med linjen med en opdeling vha. en kunstig neuron.
...
Strengt taget er der nok ikke tale om minima, men i stedet at vi enten er tæt på et minimum eller oftere er landet på et plateau, så der er svært at komme længere ned, men vi vil alligevel bruge betegnelse minimum. 

Spørgsmål er, om der i praksis er den store forskel på de to:
