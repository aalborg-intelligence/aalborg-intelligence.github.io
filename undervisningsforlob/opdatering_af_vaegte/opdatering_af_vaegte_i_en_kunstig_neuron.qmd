...
* Vælg så 1 iteration, klik på \"Træn odel\" og sammenlign med dine egne resultatet.
...
* Gentag opgave 1-5 men med *cross-entropy* som tabsfunktion i stedet for *squared error*. Kontroller selv dine udregninger ved brug af appen i opgave 5.
