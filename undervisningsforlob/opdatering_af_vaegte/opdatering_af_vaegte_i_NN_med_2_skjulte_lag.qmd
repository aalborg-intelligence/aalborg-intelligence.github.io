...
Hvis $4 < x_1 + x_2 < 7$ er targetværdien er $1$, ellers er targetværdien $0$. Det stemmer med det meget lille datasæt, vi indtil nu har anvendt. 

I denne [Excel-fil](data/traeningsdata200punkter.xlsx) er der 200 linjer med træningsdata, som vi vil bruge til at træne et neutralt netværk med 2 skjulte lag. Men vi vil helt sikkert ikke selv lave opdateringerne af vægtene manuelt. I stedet vil vi bruge [denne  app](https://apps01.math.aau.dk/ai/dyi_net/){target="_blank"}.
