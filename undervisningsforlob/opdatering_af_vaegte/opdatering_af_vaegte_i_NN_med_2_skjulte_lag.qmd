...
I denne [Excelfil](data/traeningsdata200punkter.xlsx) er der 200 linjer med træningsdata, som vi vil bruge til at træne et neutralt netværk med 2 skjulte lag. Men vi vil helt sikkert ikke selv lave opdateringerne af vægtene manuelt. I stedet vil vi bruge [neuralt netværk app'en](https://apps01.math.aau.dk/ai/dyi_net/){target="_blank"}.
...
* Undersøg i datasættet i Excelfilen, hvor mange af datapunkterne, der har $t=1$. * Brug metoden fra det nævnte forløb til at vurdere, om den fundne værdi af tabsfunktionen måske er for stor, eller om den godt kunne være passende lille. 
...
* Træn netværket. 
* Gentag træningen flere gange, hvilket giver lidt forskellige resultater pga. de tilfældige startvægte.
...
* Prøv evt. med endnu flere iterationer, hvis du har tålmodighed til det.
