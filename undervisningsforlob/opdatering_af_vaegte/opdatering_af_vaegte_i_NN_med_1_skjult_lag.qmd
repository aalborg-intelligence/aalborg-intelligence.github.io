...
Forudsætningerne kan med fordel dækkes ved hjælp af [noten om simple neurale netværk](../../noter/simple_neurale_net/simple_neurale_net.qmd){target="_blank"}, da notationen derfra vil blive anvendt i dette forløb, samt [noten om tabsfunktioner](../../noter/tabsfunktioner/tabsfunktioner.html){target="_blank"}.
...
I neurale netværk er der ofte rigtig mange inputvariable (features), rigtigt mange vægte og rigtig mange træningsdata. 
...
Vi vil lave et netværk med 2 inputvariable ($x_1$ og $x_2$), 1 neuron i det skjulte lag ($y$) og 1 neuron i outputlaget ($o$). Netværket er illustreret i [@fig-simple_NN2]{.nolink}.

![Grafisk illustration af et neuralt netværk med 2 inputvariable og ét skjult lag, som består af én neuron.](images/simple_NN2.png){width=75% #fig-simple_NN2}
...
* Lav udregninger tilsvarende dem i opgave 4 og opdatér $r$-vægtene.
