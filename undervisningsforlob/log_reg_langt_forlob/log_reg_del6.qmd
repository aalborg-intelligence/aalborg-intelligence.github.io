...
## Aktivitet 1 {.aimat}
Start med at se denne video (eller læs afsnittet [maksimum likelihood estimation](../../noter/logistisk/log-reg.qmd#maksimum-likelihood-estimation)):
...
Fra afsnittet [Maksimum likelihood estimation](../../noter/logistisk/log-reg.qmd#maksimum-likelihood-estimation) fandt vi frem til, at **log-likelihoodfunktionen** kan skrives på denne måde:
...
![Illustration af Excel ark til bestemmelse af a og b samt brug af problemløser.](../../noter/logistisk/images/excellogregbil.png)
...
* Brug [datasættet](../../noter/logistisk/data/blodtryk.xlsx) med de 2000 datapunkter og benyt problemløsning i Excel til at vise, at $a=0.022$ og $b=-3.9$ optimerer løsningen.

:::

{{< include ../space.qmd >}}

[$\leftarrow$ Forrige](log_reg_del5.qmd){.prev}
[Næste $\rightarrow$](log_reg_del7.qmd){.next}
