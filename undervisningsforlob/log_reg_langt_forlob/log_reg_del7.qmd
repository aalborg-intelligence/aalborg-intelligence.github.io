...
## Aktivitet 1 {.aimat}
Læs afsnittet om [multipel logistisk regression](../../noter/logistisk/log-reg.qmd#multipel-logistisk-regression).
...
## Aktivitet 3 {.aimat}
Læs afsnittet om [prædiktion](../../noter/logistisk/log-reg.qmd#prædiktion).
...
[$\leftarrow$ Forrige](log_reg_del6.qmd){.prev}
[Næste $\rightarrow$](log_reg_eksamen.qmd){.next}
