...
## Aktivitet 1 {.aimat}
Start med at se denne video (eller læs afsnittet [den logistiske regressionsmodel](../../noter/logistisk/log-reg.qmd#den-logistiske-regressionsmodel)):
...
[$\leftarrow$ Forrige](log_reg_del2.qmd){.prev}
[Næste $\rightarrow$](log_reg_del4.qmd){.next}
