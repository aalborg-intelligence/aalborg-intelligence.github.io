...
description: "I opbygningen af kunstige neurale netværk er aktiveringsfunktioner helt centrale. Og aktiveringsfunktioner skal differentieres -- det handler dette forløb om."
categories:
  - "01_A-niveau"
  - "04_Kort"
---
...
Bemærk, at dette forløb indgår som del 1 i et [længere forløb om kunstige neuroner](kunstige_neuroner_langt_forlob/kunstige_neuroner_forside.qmd). 
...
I opbygningen af kunstige neurale netværk er aktiveringsfunktioner helt centrale. Hvis man ikke bruger aktiveringsfunktioner i et kunstigt neuralt netværk, vil man faktisk bare bygge en stor lineær funktion af inputværdierne. Og lineære funktioner kan man ikke prædiktere ret meget med!

Når man skal træne en [kunstig neuron](../noter/kunstige_neuroner/kunstige_neuroner.qmd){target="_blank"}, et [simpelt neuralt netværk](../noter/simple_neurale_net/simple_neurale_net.qmd){target="_blank"} eller et helt [generelt neuralt netværk](../noter/neurale_net/neurale_net.qmd){target="_blank"}, skal man kunne differentiere de aktiveringsfunktioner, som indgår. I dette forløb vil vi arbejde med nogle af de mange forskellige aktiveringsfunktioner, som anvendes i den virkelige verden. Vi skal se på grafer og værdimængder -- og så skal vi mest af alt differentiere funktionerne!
