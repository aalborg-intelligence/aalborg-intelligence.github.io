...
Når man skal træne en [perceptron](../noter/perceptron/perceptron.qmd), et [simpelt neuralt netværk](../noter/simple_neurale_net/simple_neurale_net.qmd) eller et helt [generelt neuralt netværk](../noter/neurale_net/neurale_net.qmd), skal man kunne differentiere de aktiveringsfunktioner, som indgår. I dette forløb vil vi arbejde med nogle af de mange forskellige aktiveringsfunktioner, som anvendes i den virkelige verden. Vi skal se på grafer og værdimængde -- og så skal vi mest af alt differentiere dem!
