...
description: "Et andengradspolynomium kan have enten ingen, én eller to rødder. I skal her lære om, hvordan man kan bruge kunstig intelligens til at bestemme antallet af rødder i et andengradspolynomium."
categories:
  - "02_B-niveau"
  - "04_Kort"
---
...
$$
Grafen for et andengradspolynomium kaldes som bekendt for en *parabel*. I [@fig-antal_roedder]{.nolink} ses tre eksempler på sådanne parabler.
...
f(x)=x^2+bx+c,
$$
hvor $b=B/A$ og $c=C/A$. Man kan altså bare tage sit oprindelige andengradspolynomium $g(x)=Ax^2+Bx+C$ og dividere igennem med $A$. Lad os illustrere det med et eksempel.
...
f(x)=x^2-2x-3
$$
Her er koefficienterne $a=1, b=-2$ og $c=-3$. Men $f$ har præcis samme rødder som $g$ -- nemlig $-1$ og $3$. Dette ses også illustreret i [@fig-samme-roedder]{.nolink}, hvor grafen for $g$ og $f$ begge skærer $x$-aksen i $-1$ og $3$.
...
![](polynomium_filer/regneark.png){width=50% fig-align='center'}
...
+ Indtegn jeres værdier af $b$ og $c$ i et koordinatsystem, hvor værdien af $b$ er på $x$-aksen, og værdien af $c$ er på $y$-aksen. Hvis $(b,c)$-punktet svarer til et andengradspolynomium, som har rødder (det vil sige, at $t=1$), farves punktet rødt og ellers farves det blåt (det vil sige, at $t=-1$). I videoen herunder er det vist, hvordan man gør i GeoGebra:
...
hvor $b$ og $c$ jo svarer til koefficienter i forskellige andengradspolynomier med forskrift $f(x)=x^2+bx+c$.
...
Idéen med at prøve at adskille to grupper af punkter med en ret linje bruges blandt andet i den AI-metode, som kaldes for [kunstige neuroner](../noter/kunstige_neuroner/kunstige_neuroner.qmd){target="_blank"}. Metoden kan bruges, når man gerne vil kunne adskille to grupper af punkter fra hinanden baseret på en række forskellige værdier -- disse værdier kalder man for **features**. Du kender måske kandidattests, hvor man på baggrund af svarene fra en række spørgsmål gerne vil kunne forudsige, om en person vil stemme på rød eller blå blok til det næste valg. Det kunne man for eksempel bruge en kunstig neuron til at hjælpe med at afgøre.

Hvis du vil prøve at bruge en kunstig neuron på dine data om andengradspolynomier, kan du gøre det [her](https://apps01.math.aau.dk/ai/neuron/).
...
[^4]: Du er nok vant til at møde linjens ligning på denne form: $a \cdot x+b \cdot y+c=0$. Skrivemåden, vi bruger her, er $w_0+w_1 \cdot x + w_2 \cdot y=0$. Det vil sige, at i forhold til den skrivemåde, som du kender, så er $w_0=c, w_1=a$ og $w_2=b$. 
