...
description: 'Et længere forløb om logistisk regression som supplerende stof på A-niveau inklusiv spørgsmål til mundtlig eksamen'
...
I dette længere forløb skal du lære om logistisk regression, som er en metode inden for kunstig intelligens, som - i modsætning til neurale netværk - ikke er black-box. Du vil herunder lære, at logistisk regression ikke er det samme som logistisk vækst. 

Måske du har haft om logistisk vækst og i dit CAS-værktøj er stødt på en kommando til logistisk regression, men dette forløb er noget andet, selvom noget vil virke bekendt.
...
Til sidst er der en kort lærervejledning, som elever kan se bort fra.
...
* Genskab figur 1 i materialet ud fra de første 100 punkter og overvej, hvorfor det er en dårlig idé at bruge alle 2000 punkter. Du kan enten gøre dette i dit eget CAS-værktøj eller i Excel. Hvis du ikke er vant til at lave grafer i Excel, er det nok lettest at anvende det program, som du normalt bruger.
...
Indstil pivottabellen som vist på figuren nedenfor. Bemærk, at du skal trække Blodtryk og Syg ned fra listen foroven til Kolonner, Rækker og Værdier i bunden. Under Værdier vil der i første omgang stå "Sum af Syg", så klik på pilen, vælg "Værdifeltindstillinger" og ændr det til "Antal af Syg".
...
* Lav de tilhørende opgaver i materialet. Hint til sidste spørgsmål: Start med at overveje, hvilken værdi $\mathrm{e}^{-a\cdot x+b}$ skal have, derefter hvilken værdi $a\cdot x+b$ skal have, og til sidst hvilken værdi $x$ skal have.
...
* Anvend igen Excel arket med de 2000 datapunkter, og benyt problemløseren i Excel til at vise, at $a=0{,}022$ og $b=-3{,}9$ optimerer løsningen.
* Lav de tilhørende opgaver i materialet.
...
## Til læreren
I del 1 kan inddelingen i intervaller også ske i elevernes eget CAS-værktøj, hvis det foretrækkes. Der kan dog evt. være en pointe i at lade eleverne stifte bekendtskab med begrebet pivottabel i Excel uanset.
